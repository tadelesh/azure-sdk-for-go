...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/compute/mgmt/2021-12-01/compute"
...
type EncryptionSetIdentity struct {
	...
	UserAssignedIdentities map[string]*EncryptionSetIdentityUserAssignedIdentitiesValue `json:"userAssignedIdentities"`
}
...
// EncryptionSetIdentityUserAssignedIdentitiesValue ...
type EncryptionSetIdentityUserAssignedIdentitiesValue struct {
...
// MarshalJSON is the custom marshaler for EncryptionSetIdentityUserAssignedIdentitiesValue.
func (esiAiv EncryptionSetIdentityUserAssignedIdentitiesValue) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
