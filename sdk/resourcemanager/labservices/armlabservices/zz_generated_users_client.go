...
func NewUsersClient(con *arm.Connection, subscriptionID string) *UsersClient {
	return &UsersClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *UsersClient) listByLabHandleResponse(resp *http.Response) (UsersListByLabResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PagedUsers); err != nil {
		return UsersListByLabResponse{}, err
	}
	return result, nil
}
