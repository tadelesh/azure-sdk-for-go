...
func (r RecurrencePattern) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "expirationDate", (*dateType)(r.ExpirationDate))
...
func (r *RecurrencePattern) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expirationDate":
			var aux dateType
			err = unpopulate(val, &aux)
			r.ExpirationDate = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "frequency":
...
func (s ScheduleUpdateProperties) marshalInternal(objectMap map[string]interface{}) {
	...
	populate(objectMap, "startAt", (*timeRFC3339)(s.StartAt))
	populate(objectMap, "stopAt", (*timeRFC3339)(s.StopAt))
...
func (s *ScheduleUpdateProperties) unmarshalInternal(rawMsg map[string]json.RawMessage) error {
	for key, val := range rawMsg {
		...
		case "startAt":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.StartAt = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "stopAt":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.StopAt = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "timeZoneId":
...
func (u UserProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "invitationSent", (*timeRFC3339)(u.InvitationSent))
...
func (u *UserProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "invitationSent":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			u.InvitationSent = (*time.Time)(&aux)
			delete(rawMsg, key)
