...
func NewWorkspaceFeaturesClient(con *arm.Connection, subscriptionID string) *WorkspaceFeaturesClient {
	return &WorkspaceFeaturesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *WorkspaceFeaturesClient) listHandleResponse(resp *http.Response) (WorkspaceFeaturesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ListAmlUserFeatureResult); err != nil {
		return WorkspaceFeaturesListResponse{}, err
	}
	return result, nil
}
