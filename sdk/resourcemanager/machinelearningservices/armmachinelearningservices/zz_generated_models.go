...
func (a AmlComputeProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "allocationStateTransitionTime", (*timeRFC3339)(a.AllocationStateTransitionTime))
...
func (a *AmlComputeProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "allocationStateTransitionTime":
			...
			a.AllocationStateTransitionTime = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (c ComputeInstanceLastOperation) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "operationTime", (*timeRFC3339)(c.OperationTime))
	return json.Marshal(objectMap)
}
