...
func NewWorkspaceConnectionsClient(con *arm.Connection, subscriptionID string) *WorkspaceConnectionsClient {
	return &WorkspaceConnectionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
