...
// method.
func (client *WorkspacesClient) BeginDiagnose(ctx context.Context, resourceGroupName string, workspaceName string, options *WorkspacesClientBeginDiagnoseOptions) (*armruntime.Poller[WorkspacesClientDiagnoseResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.diagnose(ctx, resourceGroupName, workspaceName, options)
		if err != nil {
			return nil, err
		}
		return armruntime.NewPoller[WorkspacesClientDiagnoseResponse]("WorkspacesClient.Diagnose", "location", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[WorkspacesClientDiagnoseResponse]("WorkspacesClient.Diagnose", options.ResumeToken, client.pl, nil)
	}
}
...
// method.
func (client *WorkspacesClient) BeginPrepareNotebook(ctx context.Context, resourceGroupName string, workspaceName string, options *WorkspacesClientBeginPrepareNotebookOptions) (*armruntime.Poller[WorkspacesClientPrepareNotebookResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.prepareNotebook(ctx, resourceGroupName, workspaceName, options)
		if err != nil {
			return nil, err
		}
		return armruntime.NewPoller[WorkspacesClientPrepareNotebookResponse]("WorkspacesClient.PrepareNotebook", "location", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[WorkspacesClientPrepareNotebookResponse]("WorkspacesClient.PrepareNotebook", options.ResumeToken, client.pl, nil)
	}
}
...
// method.
func (client *WorkspacesClient) BeginResyncKeys(ctx context.Context, resourceGroupName string, workspaceName string, options *WorkspacesClientBeginResyncKeysOptions) (*armruntime.Poller[WorkspacesClientResyncKeysResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.resyncKeys(ctx, resourceGroupName, workspaceName, options)
		if err != nil {
			return nil, err
		}
		return armruntime.NewPoller[WorkspacesClientResyncKeysResponse]("WorkspacesClient.ResyncKeys", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[WorkspacesClientResyncKeysResponse]("WorkspacesClient.ResyncKeys", options.ResumeToken, client.pl, nil)
	}
}
