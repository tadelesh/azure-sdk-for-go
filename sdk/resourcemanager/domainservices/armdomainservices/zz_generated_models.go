...
func (c ConfigDiagnostics) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "lastExecuted", (*timeRFC1123)(c.LastExecuted))
...
func (h HealthAlert) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastDetected", (*timeRFC3339)(h.LastDetected))
	populate(objectMap, "name", h.Name)
	populate(objectMap, "raised", (*timeRFC3339)(h.Raised))
...
func (l LdapsSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "certificateNotAfter", (*timeRFC3339)(l.CertificateNotAfter))
...
func (l *LdapsSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certificateNotAfter":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			l.CertificateNotAfter = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (r ReplicaSet) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "healthLastEvaluated", (*timeRFC1123)(r.HealthLastEvaluated))
...
func (r *ReplicaSet) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "healthLastEvaluated":
			var aux timeRFC1123
			err = unpopulate(val, &aux)
			r.HealthLastEvaluated = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "healthMonitors":
