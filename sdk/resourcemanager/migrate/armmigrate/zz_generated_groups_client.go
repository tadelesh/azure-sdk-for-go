...
func (client *GroupsClient) ListByProject(resourceGroupName string, projectName string, options *GroupsClientListByProjectOptions) *runtime.Pager[GroupsClientListByProjectResponse] {
	return runtime.NewPager(runtime.PageProcessor[GroupsClientListByProjectResponse]{
