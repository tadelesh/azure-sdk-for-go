...
// ListByProject - Get data of all the machines available in the project. Returns a json array of objects of type 'machine'
// defined in Models section.
// If the operation fails it returns an *azcore.ResponseError type.
// resourceGroupName - Name of the Azure Resource Group that project is part of.
// projectName - Name of the Azure Migrate project.
// options - MachinesClientListByProjectOptions contains the optional parameters for the MachinesClient.ListByProject method.
func (client *MachinesClient) ListByProject(resourceGroupName string, projectName string, options *MachinesClientListByProjectOptions) *MachinesClientListByProjectPager {
	return &MachinesClientListByProjectPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listByProjectCreateRequest(ctx, resourceGroupName, projectName, options)
		},
		advancer: func(ctx context.Context, resp MachinesClientListByProjectResponse) (*policy.Request, error) {
