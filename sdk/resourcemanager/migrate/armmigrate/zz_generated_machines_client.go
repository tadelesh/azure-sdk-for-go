...
func (client *MachinesClient) ListByProject(resourceGroupName string, projectName string, options *MachinesClientListByProjectOptions) *runtime.Pager[MachinesClientListByProjectResponse] {
	return runtime.NewPager(runtime.PageProcessor[MachinesClientListByProjectResponse]{
