...
func ExampleAssessedMachinesClient_ListByAssessment() {
	...
	client := armmigrate.NewAssessedMachinesClient("<subscription-id>", cred, nil)
	pager := client.ListByAssessment("<resource-group-name>",
		"<project-name>",
		"<group-name>",
		"<assessment-name>",
		nil)
