...
func (client *InstanceFailoverGroupsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, locationName string, failoverGroupName string, parameters InstanceFailoverGroup, options *InstanceFailoverGroupsClientBeginCreateOrUpdateOptions) (*armruntime.Poller[InstanceFailoverGroupsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[InstanceFailoverGroupsClientCreateOrUpdateResponse]("InstanceFailoverGroupsClient.CreateOrUpdate", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[InstanceFailoverGroupsClientCreateOrUpdateResponse]("InstanceFailoverGroupsClient.CreateOrUpdate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *InstanceFailoverGroupsClient) BeginDelete(ctx context.Context, resourceGroupName string, locationName string, failoverGroupName string, options *InstanceFailoverGroupsClientBeginDeleteOptions) (*armruntime.Poller[InstanceFailoverGroupsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[InstanceFailoverGroupsClientDeleteResponse]("InstanceFailoverGroupsClient.Delete", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[InstanceFailoverGroupsClientDeleteResponse]("InstanceFailoverGroupsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *InstanceFailoverGroupsClient) BeginFailover(ctx context.Context, resourceGroupName string, locationName string, failoverGroupName string, options *InstanceFailoverGroupsClientBeginFailoverOptions) (*armruntime.Poller[InstanceFailoverGroupsClientFailoverResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[InstanceFailoverGroupsClientFailoverResponse]("InstanceFailoverGroupsClient.Failover", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[InstanceFailoverGroupsClientFailoverResponse]("InstanceFailoverGroupsClient.Failover", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *InstanceFailoverGroupsClient) BeginForceFailoverAllowDataLoss(ctx context.Context, resourceGroupName string, locationName string, failoverGroupName string, options *InstanceFailoverGroupsClientBeginForceFailoverAllowDataLossOptions) (*armruntime.Poller[InstanceFailoverGroupsClientForceFailoverAllowDataLossResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[InstanceFailoverGroupsClientForceFailoverAllowDataLossResponse]("InstanceFailoverGroupsClient.ForceFailoverAllowDataLoss", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[InstanceFailoverGroupsClientForceFailoverAllowDataLossResponse]("InstanceFailoverGroupsClient.ForceFailoverAllowDataLoss", options.ResumeToken, client.pl, nil)
	}
}
