...
func (client *SyncAgentsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, serverName string, syncAgentName string, parameters SyncAgent, options *SyncAgentsClientBeginCreateOrUpdateOptions) (*armruntime.Poller[SyncAgentsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[SyncAgentsClientCreateOrUpdateResponse]("SyncAgentsClient.CreateOrUpdate", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[SyncAgentsClientCreateOrUpdateResponse]("SyncAgentsClient.CreateOrUpdate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *SyncAgentsClient) BeginDelete(ctx context.Context, resourceGroupName string, serverName string, syncAgentName string, options *SyncAgentsClientBeginDeleteOptions) (*armruntime.Poller[SyncAgentsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[SyncAgentsClientDeleteResponse]("SyncAgentsClient.Delete", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[SyncAgentsClientDeleteResponse]("SyncAgentsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
