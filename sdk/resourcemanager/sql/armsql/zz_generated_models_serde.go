...
// MarshalJSON implements the json.Marshaller interface for type IPv6FirewallRuleList.
func (i IPv6FirewallRuleList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "values", i.Values)
	return json.Marshal(objectMap)
}
