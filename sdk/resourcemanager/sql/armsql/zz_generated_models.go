...
// IPv6FirewallRuleList - A list of IPv6 server firewall rules.
type IPv6FirewallRuleList struct {
	Values []*IPv6FirewallRule `json:"values,omitempty"`
}
...
// ServerTrustCertificatesListResult - A list of the server trust certificates which are used for secure communication between
