...
func (client *LiveEventsClient) BeginAllocate(ctx context.Context, resourceGroupName string, accountName string, liveEventName string, options *LiveEventsClientBeginAllocateOptions) (*armruntime.Poller[LiveEventsClientAllocateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LiveEventsClientAllocateResponse]("LiveEventsClient.Allocate", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LiveEventsClientAllocateResponse]("LiveEventsClient.Allocate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *LiveEventsClient) BeginCreate(ctx context.Context, resourceGroupName string, accountName string, liveEventName string, parameters LiveEvent, options *LiveEventsClientBeginCreateOptions) (*armruntime.Poller[LiveEventsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LiveEventsClientCreateResponse]("LiveEventsClient.Create", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LiveEventsClientCreateResponse]("LiveEventsClient.Create", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *LiveEventsClient) BeginDelete(ctx context.Context, resourceGroupName string, accountName string, liveEventName string, options *LiveEventsClientBeginDeleteOptions) (*armruntime.Poller[LiveEventsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LiveEventsClientDeleteResponse]("LiveEventsClient.Delete", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LiveEventsClientDeleteResponse]("LiveEventsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *LiveEventsClient) BeginReset(ctx context.Context, resourceGroupName string, accountName string, liveEventName string, options *LiveEventsClientBeginResetOptions) (*armruntime.Poller[LiveEventsClientResetResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LiveEventsClientResetResponse]("LiveEventsClient.Reset", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LiveEventsClientResetResponse]("LiveEventsClient.Reset", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *LiveEventsClient) BeginStart(ctx context.Context, resourceGroupName string, accountName string, liveEventName string, options *LiveEventsClientBeginStartOptions) (*armruntime.Poller[LiveEventsClientStartResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LiveEventsClientStartResponse]("LiveEventsClient.Start", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LiveEventsClientStartResponse]("LiveEventsClient.Start", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *LiveEventsClient) BeginStop(ctx context.Context, resourceGroupName string, accountName string, liveEventName string, parameters LiveEventActionInput, options *LiveEventsClientBeginStopOptions) (*armruntime.Poller[LiveEventsClientStopResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LiveEventsClientStopResponse]("LiveEventsClient.Stop", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LiveEventsClientStopResponse]("LiveEventsClient.Stop", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *LiveEventsClient) BeginUpdate(ctx context.Context, resourceGroupName string, accountName string, liveEventName string, parameters LiveEvent, options *LiveEventsClientBeginUpdateOptions) (*armruntime.Poller[LiveEventsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LiveEventsClientUpdateResponse]("LiveEventsClient.Update", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LiveEventsClientUpdateResponse]("LiveEventsClient.Update", options.ResumeToken, client.pl, nil)
	}
}
