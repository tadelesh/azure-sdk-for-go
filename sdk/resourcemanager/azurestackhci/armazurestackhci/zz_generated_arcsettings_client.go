...
func NewArcSettingsClient(con *arm.Connection, subscriptionID string) *ArcSettingsClient {
	return &ArcSettingsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ArcSettingsClient) listByClusterHandleResponse(resp *http.Response) (ArcSettingsListByClusterResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ArcSettingList); err != nil {
		return ArcSettingsListByClusterResponse{}, err
	}
	return result, nil
}
