...
func (c ClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastBillingTimestamp", (*timeRFC3339)(c.LastBillingTimestamp))
	populate(objectMap, "lastSyncTimestamp", (*timeRFC3339)(c.LastSyncTimestamp))
	populate(objectMap, "provisioningState", c.ProvisioningState)
	populate(objectMap, "registrationTimestamp", (*timeRFC3339)(c.RegistrationTimestamp))
...
func (c *ClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastBillingTimestamp":
			...
			c.LastBillingTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastSyncTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.LastSyncTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		...
		case "registrationTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.RegistrationTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
