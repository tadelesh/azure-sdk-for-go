...
func NewCreatorsClient(con *arm.Connection, subscriptionID string) *CreatorsClient {
	return &CreatorsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *CreatorsClient) listByAccountHandleResponse(resp *http.Response) (CreatorsListByAccountResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.CreatorList); err != nil {
		return CreatorsListByAccountResponse{}, err
	}
	return result, nil
}
