...
func NewOperationStatusClient(con *arm.Connection, subscriptionID string) *OperationStatusClient {
	return &OperationStatusClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}

// Get - Gets the operation status for a resource.
// If the operation fails it returns the *CloudError error type.
func (client *OperationStatusClient) Get(ctx context.Context, location string, operationID string, options *OperationStatusGetOptions) (OperationStatusGetResponse, error) {
...
func (client *OperationStatusClient) getCreateRequest(ctx context.Context, location string, operationID string, options *OperationStatusGetOptions) (*policy.Request, error) {
