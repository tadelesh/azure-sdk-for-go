...
func NewOperationResultClient(con *arm.Connection, subscriptionID string) *OperationResultClient {
	return &OperationResultClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
