...
func NewBackupInstancesClient(con *arm.Connection, subscriptionID string) *BackupInstancesClient {
	return &BackupInstancesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *BackupInstancesClient) listHandleResponse(resp *http.Response) (BackupInstancesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.BackupInstanceResourceList); err != nil {
		return BackupInstancesListResponse{}, err
	}
	return result, nil
}
