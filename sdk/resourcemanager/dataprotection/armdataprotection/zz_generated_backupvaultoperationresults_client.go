...
func NewBackupVaultOperationResultsClient(con *arm.Connection, subscriptionID string) *BackupVaultOperationResultsClient {
	return &BackupVaultOperationResultsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
