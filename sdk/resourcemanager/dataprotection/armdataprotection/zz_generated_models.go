...
func (a AzureBackupDiscreteRecoveryPoint) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "recoveryPointTime", (*timeRFC3339)(a.RecoveryPointTime))
...
func (a *AzureBackupDiscreteRecoveryPoint) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "recoveryPointTime":
			...
			a.RecoveryPointTime = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (r RecoveryPointDataStoreDetails) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "expiryTime", (*timeRFC3339)(r.ExpiryTime))
	populate(objectMap, "id", r.ID)
	populate(objectMap, "metaData", r.MetaData)
	populate(objectMap, "rehydrationExpiryTime", (*timeRFC3339)(r.RehydrationExpiryTime))
...
func (r *RecoveryPointDataStoreDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "rehydrationExpiryTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			r.RehydrationExpiryTime = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (r RestoreJobRecoveryPointDetails) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "recoveryPointTime", (*timeRFC3339)(r.RecoveryPointTime))
	return json.Marshal(objectMap)
}
...
func (r *RestoreJobRecoveryPointDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "recoveryPointTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			r.RecoveryPointTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
