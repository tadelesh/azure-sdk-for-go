...
func NewExportJobsClient(con *arm.Connection, subscriptionID string) *ExportJobsClient {
	return &ExportJobsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
