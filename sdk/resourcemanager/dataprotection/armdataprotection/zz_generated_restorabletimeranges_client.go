...
func NewRestorableTimeRangesClient(con *arm.Connection, subscriptionID string) *RestorableTimeRangesClient {
	return &RestorableTimeRangesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
