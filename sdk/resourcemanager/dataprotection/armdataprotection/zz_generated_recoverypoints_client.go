...
func NewRecoveryPointsClient(con *arm.Connection, subscriptionID string) *RecoveryPointsClient {
	return &RecoveryPointsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *RecoveryPointsClient) listHandleResponse(resp *http.Response) (RecoveryPointsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.AzureBackupRecoveryPointResourceList); err != nil {
		return RecoveryPointsListResponse{}, err
	}
	return result, nil
}
