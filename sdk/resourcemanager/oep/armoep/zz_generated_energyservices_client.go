...
func (client *EnergyServicesClient) BeginCreate(ctx context.Context, resourceGroupName string, resourceName string, options *EnergyServicesClientBeginCreateOptions) (*armruntime.Poller[EnergyServicesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[EnergyServicesClientCreateResponse]("EnergyServicesClient.Create", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[EnergyServicesClientCreateResponse]("EnergyServicesClient.Create", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *EnergyServicesClient) BeginDelete(ctx context.Context, resourceGroupName string, resourceName string, options *EnergyServicesClientBeginDeleteOptions) (*armruntime.Poller[EnergyServicesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[EnergyServicesClientDeleteResponse]("EnergyServicesClient.Delete", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[EnergyServicesClientDeleteResponse]("EnergyServicesClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
