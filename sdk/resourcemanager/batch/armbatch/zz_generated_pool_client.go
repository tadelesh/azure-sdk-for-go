...
func NewPoolClient(con *arm.Connection, subscriptionID string) *PoolClient {
	return &PoolClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *PoolClient) listByBatchAccountHandleResponse(resp *http.Response) (PoolListByBatchAccountResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ListPoolsResult); err != nil {
		return PoolListByBatchAccountResponse{}, err
	}
	return result, nil
}
