...
func NewApplicationPackageClient(con *arm.Connection, subscriptionID string) *ApplicationPackageClient {
	return &ApplicationPackageClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ApplicationPackageClient) listHandleResponse(resp *http.Response) (ApplicationPackageListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ListApplicationPackagesResult); err != nil {
		return ApplicationPackageListResponse{}, err
	}
	return result, nil
}
