...
func (client *CloudLinksClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, privateCloudName string, cloudLinkName string, cloudLink CloudLink, options *CloudLinksClientBeginCreateOrUpdateOptions) (*armruntime.Poller[CloudLinksClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[CloudLinksClientCreateOrUpdateResponse]("CloudLinksClient.CreateOrUpdate", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[CloudLinksClientCreateOrUpdateResponse]("CloudLinksClient.CreateOrUpdate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *CloudLinksClient) BeginDelete(ctx context.Context, resourceGroupName string, privateCloudName string, cloudLinkName string, options *CloudLinksClientBeginDeleteOptions) (*armruntime.Poller[CloudLinksClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[CloudLinksClientDeleteResponse]("CloudLinksClient.Delete", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[CloudLinksClientDeleteResponse]("CloudLinksClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
