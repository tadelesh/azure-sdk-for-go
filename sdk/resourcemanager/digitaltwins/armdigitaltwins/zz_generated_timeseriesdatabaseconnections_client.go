...
func NewTimeSeriesDatabaseConnectionsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *TimeSeriesDatabaseConnectionsClient {
	if options == nil {
