...
func (client *PrivateLinkResourcesClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, resourceID string, options *PrivateLinkResourcesGetOptions) (*policy.Request, error) {
