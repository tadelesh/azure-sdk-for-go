...
func NewDigitalTwinsEndpointClient(con *arm.Connection, subscriptionID string) *DigitalTwinsEndpointClient {
	return &DigitalTwinsEndpointClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *DigitalTwinsEndpointClient) listHandleResponse(resp *http.Response) (DigitalTwinsEndpointListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.DigitalTwinsEndpointResourceListResult); err != nil {
		return DigitalTwinsEndpointListResponse{}, err
	}
	return result, nil
}
