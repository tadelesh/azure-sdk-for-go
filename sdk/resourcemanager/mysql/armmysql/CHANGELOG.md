...
- Function `*LocationBasedRecommendedActionSessionsResultClientListPager.NextPage` return value(s) have been changed from `(bool)` to `(LocationBasedRecommendedActionSessionsResultClientListResponse, error)`
...
- Function `*ServerAdministratorsClient.List` return value(s) have been changed from `(ServerAdministratorsClientListResponse, error)` to `(*ServerAdministratorsClientListPager)`
...
- Function `*ServerKeysClientListPager.NextPage` return value(s) have been changed from `(bool)` to `(ServerKeysClientListResponse, error)`
...
- Field `RawResponse` of struct `ServerAdministratorsClientDeletePollerResponse` has been removed
...
- Field `RawResponse` of struct `ServersClientUpgradePollerResponse` has been removed
...
- Field `RawResponse` of struct `ServerAdministratorsClientCreateOrUpdatePollerResponse` has been removed
...
- New function `*ServerAdministratorsClientListPager.More() bool`
...
- New function `*ServerAdministratorsClientListPager.NextPage(context.Context) (ServerAdministratorsClientListResponse, error)`
...
- New function `*ServerKeysClientListPager.More() bool`
...
- New struct `ServerAdministratorsClientListPager`
