	...
	poller, err := client.BeginCreate(ctx,
		...
		ServerForCreate{
			...
			Properties: &ServerPropertiesForRestore{
				...
				SourceServerID:     to.StringPtr("/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/SourceResourceGroup/providers/Microsoft.DBforMySQL/servers/sourceserver"),
			},
			SKU: &SKU{
	...
	poller, err = client.BeginCreate(ctx,
		...
		ServerForCreate{
			...
			Properties: &ServerPropertiesForReplica{
				...
				SourceServerID: to.StringPtr("/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/MasterResourceGroup/providers/Microsoft.DBforMySQL/servers/masterserver"),
			},
		},
		&ServersBeginCreateOptions{})
	if err != nil {
	...
	poller, err := client.BeginUpgrade(ctx,
		...
		ServerUpgradeParameters{
			Properties: &ServerUpgradeParametersProperties{
				TargetServerVersion: to.StringPtr("5.7"),
			},
		},
		&ServersBeginUpgradeOptions{})
	if err != nil {
		t.Fatal(err)
	}
	_, err = poller.PollUntilDone(ctx, 30*time.Second)
...
func TestServerAdministrators_Get(t *testing.T) {
	// From example ServerAdministratorGet
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
	}()
	client := NewServerAdministratorsClient(con,
		"ffffffff-ffff-ffff-ffff-ffffffffffff")
	res, err := client.Get(ctx,
		"testrg",
		"mysqltestsvc4",
		&ServerAdministratorsGetOptions{})
	if err != nil {
		t.Fatal(err)
	}
	if res.ServerAdministratorResource.ID == nil {
		t.Fatal("ServerAdministratorResource.ID should not be nil!")
	}
}

func TestServerAdministrators_CreateOrUpdate(t *testing.T) {
	// From example ServerAdministratorCreate
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
	...
	poller, err := client.BeginCreateOrUpdate(ctx,
		...
		&ServerAdministratorsBeginCreateOrUpdateOptions{})
	if err != nil {
		t.Fatal(err)
	}
	res, err := poller.PollUntilDone(ctx, 30*time.Second)
...
func TestServerAdministrators_Delete(t *testing.T) {
	// From example ServerAdministratorsDelete
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
	...
	poller, err := client.BeginDelete(ctx,
		"testrg",
		"mysqltestsvc4",
		&ServerAdministratorsBeginDeleteOptions{})
	if err != nil {
		t.Fatal(err)
	}
	_, err = poller.PollUntilDone(ctx, 30*time.Second)
...
func TestServerAdministrators_List(t *testing.T) {
	// From example get a list of server administrators
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
	...
	_, err := client.List(ctx,
		"testrg",
		"mysqltestsvc4",
		&ServerAdministratorsListOptions{})
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestCheckNameAvailability_Execute(t *testing.T) {
	...
	_, err := client.Execute(ctx,
		NameAvailabilityRequest{
			...
			Type: to.StringPtr("Microsoft.DBforMySQL"),
		},
...
func Test_ResetQueryPerformanceInsightData(t *testing.T) {
	...
	client := NewMySQLManagementClientClient(con,
		"ffffffff-ffff-ffff-ffff-ffffffffffff")
	_, err := client.ResetQueryPerformanceInsightData(ctx,
		"testResourceGroupName",
		"testServerName",
		&MySQLManagementClientResetQueryPerformanceInsightDataOptions{})
	if err != nil {
		t.Fatal(err)
	}
}
...
func Test_CreateRecommendedActionSession(t *testing.T) {
	...
	poller, err := client.BeginCreateRecommendedActionSession(ctx,
		...
		"Index",
		"someDatabaseName",
		&MySQLManagementClientBeginCreateRecommendedActionSessionOptions{})
	if err != nil {
		t.Fatal(err)
	}
	_, err = poller.PollUntilDone(ctx, 30*time.Second)
...
func TestPrivateLinkResources_ListByServer(t *testing.T) {
	// From example Gets private link resources for MySQL.
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
...
func TestPrivateLinkResources_Get(t *testing.T) {
	// From example Gets a private link resource for MySQL.
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
...
func TestServerKeys_List(t *testing.T) {
	// From example List the keys for a MySQL Server.
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
...
func TestServerKeys_Get(t *testing.T) {
	// From example Get the MySQL Server key
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
...
func TestServerKeys_CreateOrUpdate(t *testing.T) {
	// From example Creates or updates a MySQL Server key
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
...
func TestServerKeys_Delete(t *testing.T) {
	// From example Delete the MySQL Server key
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
		}
