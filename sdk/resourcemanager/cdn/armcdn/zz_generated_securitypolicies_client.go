...
func (client *SecurityPoliciesClient) BeginCreate(ctx context.Context, resourceGroupName string, profileName string, securityPolicyName string, securityPolicy SecurityPolicy, options *SecurityPoliciesClientBeginCreateOptions) (*armruntime.Poller[SecurityPoliciesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[SecurityPoliciesClientCreateResponse]("SecurityPoliciesClient.Create", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[SecurityPoliciesClientCreateResponse]("SecurityPoliciesClient.Create", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *SecurityPoliciesClient) BeginDelete(ctx context.Context, resourceGroupName string, profileName string, securityPolicyName string, options *SecurityPoliciesClientBeginDeleteOptions) (*armruntime.Poller[SecurityPoliciesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[SecurityPoliciesClientDeleteResponse]("SecurityPoliciesClient.Delete", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[SecurityPoliciesClientDeleteResponse]("SecurityPoliciesClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *SecurityPoliciesClient) BeginPatch(ctx context.Context, resourceGroupName string, profileName string, securityPolicyName string, securityPolicyUpdateProperties SecurityPolicyUpdateParameters, options *SecurityPoliciesClientBeginPatchOptions) (*armruntime.Poller[SecurityPoliciesClientPatchResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[SecurityPoliciesClientPatchResponse]("SecurityPoliciesClient.Patch", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[SecurityPoliciesClientPatchResponse]("SecurityPoliciesClient.Patch", options.ResumeToken, client.pl, nil)
	}
}
