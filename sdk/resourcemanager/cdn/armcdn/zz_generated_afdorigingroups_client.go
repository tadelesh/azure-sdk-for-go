...
func (client *AFDOriginGroupsClient) BeginCreate(ctx context.Context, resourceGroupName string, profileName string, originGroupName string, originGroup AFDOriginGroup, options *AFDOriginGroupsClientBeginCreateOptions) (*armruntime.Poller[AFDOriginGroupsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[AFDOriginGroupsClientCreateResponse]("AFDOriginGroupsClient.Create", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[AFDOriginGroupsClientCreateResponse]("AFDOriginGroupsClient.Create", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *AFDOriginGroupsClient) BeginDelete(ctx context.Context, resourceGroupName string, profileName string, originGroupName string, options *AFDOriginGroupsClientBeginDeleteOptions) (*armruntime.Poller[AFDOriginGroupsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[AFDOriginGroupsClientDeleteResponse]("AFDOriginGroupsClient.Delete", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[AFDOriginGroupsClientDeleteResponse]("AFDOriginGroupsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *AFDOriginGroupsClient) BeginUpdate(ctx context.Context, resourceGroupName string, profileName string, originGroupName string, originGroupUpdateProperties AFDOriginGroupUpdateParameters, options *AFDOriginGroupsClientBeginUpdateOptions) (*armruntime.Poller[AFDOriginGroupsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[AFDOriginGroupsClientUpdateResponse]("AFDOriginGroupsClient.Update", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[AFDOriginGroupsClientUpdateResponse]("AFDOriginGroupsClient.Update", options.ResumeToken, client.pl, nil)
	}
}
