...
func (client *AFDEndpointsClient) BeginCreate(ctx context.Context, resourceGroupName string, profileName string, endpointName string, endpoint AFDEndpoint, options *AFDEndpointsClientBeginCreateOptions) (*armruntime.Poller[AFDEndpointsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[AFDEndpointsClientCreateResponse]("AFDEndpointsClient.Create", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[AFDEndpointsClientCreateResponse]("AFDEndpointsClient.Create", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *AFDEndpointsClient) BeginDelete(ctx context.Context, resourceGroupName string, profileName string, endpointName string, options *AFDEndpointsClientBeginDeleteOptions) (*armruntime.Poller[AFDEndpointsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[AFDEndpointsClientDeleteResponse]("AFDEndpointsClient.Delete", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[AFDEndpointsClientDeleteResponse]("AFDEndpointsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *AFDEndpointsClient) BeginPurgeContent(ctx context.Context, resourceGroupName string, profileName string, endpointName string, contents AfdPurgeParameters, options *AFDEndpointsClientBeginPurgeContentOptions) (*armruntime.Poller[AFDEndpointsClientPurgeContentResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[AFDEndpointsClientPurgeContentResponse]("AFDEndpointsClient.PurgeContent", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[AFDEndpointsClientPurgeContentResponse]("AFDEndpointsClient.PurgeContent", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *AFDEndpointsClient) BeginUpdate(ctx context.Context, resourceGroupName string, profileName string, endpointName string, endpointUpdateProperties AFDEndpointUpdateParameters, options *AFDEndpointsClientBeginUpdateOptions) (*armruntime.Poller[AFDEndpointsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[AFDEndpointsClientUpdateResponse]("AFDEndpointsClient.Update", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[AFDEndpointsClientUpdateResponse]("AFDEndpointsClient.Update", options.ResumeToken, client.pl, nil)
	}
}
