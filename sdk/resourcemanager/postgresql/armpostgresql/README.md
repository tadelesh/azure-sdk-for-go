...
The `armpostgresql` module provides operations for working with Azure Postgresql.
...
```go
client := armpostgresql.NewVirtualNetworkSubnetUsageClient(con, "<subscription ID>")
```
