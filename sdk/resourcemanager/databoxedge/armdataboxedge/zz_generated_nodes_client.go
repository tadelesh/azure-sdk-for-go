...
func NewNodesClient(con *arm.Connection, subscriptionID string) *NodesClient {
	return &NodesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
