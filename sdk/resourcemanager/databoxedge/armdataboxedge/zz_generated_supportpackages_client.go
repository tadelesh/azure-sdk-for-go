...
func NewSupportPackagesClient(con *arm.Connection, subscriptionID string) *SupportPackagesClient {
	return &SupportPackagesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
