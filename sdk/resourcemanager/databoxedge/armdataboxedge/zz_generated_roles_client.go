...
func NewRolesClient(con *arm.Connection, subscriptionID string) *RolesClient {
	return &RolesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
