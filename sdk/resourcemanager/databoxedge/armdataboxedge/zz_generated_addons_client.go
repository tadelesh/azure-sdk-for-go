...
func NewAddonsClient(con *arm.Connection, subscriptionID string) *AddonsClient {
	return &AddonsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
