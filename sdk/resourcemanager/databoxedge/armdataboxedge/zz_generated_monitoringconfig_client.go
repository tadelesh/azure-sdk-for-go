...
func NewMonitoringConfigClient(con *arm.Connection, subscriptionID string) *MonitoringConfigClient {
	return &MonitoringConfigClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
