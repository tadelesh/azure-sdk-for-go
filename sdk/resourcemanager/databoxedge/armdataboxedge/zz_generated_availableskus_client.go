...
func NewAvailableSKUsClient(con *arm.Connection, subscriptionID string) *AvailableSKUsClient {
	return &AvailableSKUsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
