...
func NewDiagnosticSettingsClient(con *arm.Connection, subscriptionID string) *DiagnosticSettingsClient {
	return &DiagnosticSettingsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
