...
func NewBandwidthSchedulesClient(con *arm.Connection, subscriptionID string) *BandwidthSchedulesClient {
	return &BandwidthSchedulesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
