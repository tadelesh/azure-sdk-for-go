...
func NewOrdersClient(con *arm.Connection, subscriptionID string) *OrdersClient {
	return &OrdersClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
