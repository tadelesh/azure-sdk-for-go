...
func (g GuestConfigurationAssignmentProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastComplianceStatusChecked", (*timeRFC3339)(g.LastComplianceStatusChecked))
...
func (g *GuestConfigurationAssignmentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastComplianceStatusChecked":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			g.LastComplianceStatusChecked = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (g GuestConfigurationAssignmentReportProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "endTime", (*timeRFC3339)(g.EndTime))
	populate(objectMap, "reportId", g.ReportID)
	populate(objectMap, "startTime", (*timeRFC3339)(g.StartTime))
...
func (v VMSSVMInfo) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastComplianceChecked", (*timeRFC3339)(v.LastComplianceChecked))
...
func (v *VMSSVMInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastComplianceChecked":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			v.LastComplianceChecked = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "latestReportId":
