...
func NewGuestConfigurationAssignmentsClient(con *arm.Connection, subscriptionID string) *GuestConfigurationAssignmentsClient {
	return &GuestConfigurationAssignmentsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
