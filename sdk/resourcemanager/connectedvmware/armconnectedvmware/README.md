...
```go
client := armconnectedvmware.NewVirtualMachinesClient(<subscription ID>, cred, nil)
```
...
client := armconnectedvmware.NewVirtualMachinesClient(<subscription ID>, cred, &options)
```
