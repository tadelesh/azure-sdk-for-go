...
func NewScriptActionsClient(con *arm.Connection, subscriptionID string) *ScriptActionsClient {
	return &ScriptActionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ScriptActionsClient) listByClusterHandleResponse(resp *http.Response) (ScriptActionsListByClusterResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ScriptActionsList); err != nil {
		return ScriptActionsListByClusterResponse{}, err
	}
	return result, nil
}
