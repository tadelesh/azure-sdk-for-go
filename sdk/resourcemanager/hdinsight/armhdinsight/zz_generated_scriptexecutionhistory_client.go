...
func NewScriptExecutionHistoryClient(con *arm.Connection, subscriptionID string) *ScriptExecutionHistoryClient {
	return &ScriptExecutionHistoryClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ScriptExecutionHistoryClient) listByClusterHandleResponse(resp *http.Response) (ScriptExecutionHistoryListByClusterResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ScriptActionExecutionHistoryList); err != nil {
		return ScriptExecutionHistoryListByClusterResponse{}, err
	}
	return result, nil
}
