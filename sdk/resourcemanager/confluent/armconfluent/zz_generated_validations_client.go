...
func NewValidationsClient(con *arm.Connection, subscriptionID string) *ValidationsClient {
	return &ValidationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
