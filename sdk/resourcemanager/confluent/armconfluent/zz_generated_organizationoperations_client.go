...
func NewOrganizationOperationsClient(con *arm.Connection) *OrganizationOperationsClient {
	return &OrganizationOperationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *OrganizationOperationsClient) listHandleResponse(resp *http.Response) (OrganizationOperationsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.OperationListResult); err != nil {
		return OrganizationOperationsListResponse{}, err
	}
	return result, nil
}
