...
func NewMarketplaceAgreementsClient(con *arm.Connection, subscriptionID string) *MarketplaceAgreementsClient {
	return &MarketplaceAgreementsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
