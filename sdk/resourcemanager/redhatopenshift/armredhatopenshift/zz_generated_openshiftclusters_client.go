...
func NewOpenShiftClustersClient(con *arm.Connection, subscriptionID string) *OpenShiftClustersClient {
	return &OpenShiftClustersClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *OpenShiftClustersClient) listHandleResponse(resp *http.Response) (OpenShiftClustersListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.OpenShiftClusterList); err != nil {
		return OpenShiftClustersListResponse{}, err
	}
	return result, nil
}
...
func (client *OpenShiftClustersClient) listByResourceGroupHandleResponse(resp *http.Response) (OpenShiftClustersListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.OpenShiftClusterList); err != nil {
		return OpenShiftClustersListByResourceGroupResponse{}, err
	}
	return result, nil
}
