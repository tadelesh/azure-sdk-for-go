...
func NewHeatMapClient(con *arm.Connection, subscriptionID string) *HeatMapClient {
	return &HeatMapClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
