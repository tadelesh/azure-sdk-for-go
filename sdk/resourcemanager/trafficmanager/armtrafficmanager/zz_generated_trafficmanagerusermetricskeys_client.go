...
func NewTrafficManagerUserMetricsKeysClient(con *arm.Connection, subscriptionID string) *TrafficManagerUserMetricsKeysClient {
	return &TrafficManagerUserMetricsKeysClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
