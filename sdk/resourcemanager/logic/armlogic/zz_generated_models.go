...
type APIResourceProperties struct {
	...
	ConnectionParameters map[string]map[string]interface{} `json:"connectionParameters,omitempty"`
...
type OpenAuthenticationAccessPolicy struct {
	...
	// READ-ONLY; Type of provider for OAuth.
	Type *OpenAuthenticationProviderType `json:"type,omitempty" azure:"ro"`
}
