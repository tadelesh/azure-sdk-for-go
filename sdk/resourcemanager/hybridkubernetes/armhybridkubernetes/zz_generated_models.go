...
func (c ConnectedClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastConnectivityTime", (*timeRFC3339)(c.LastConnectivityTime))
	populate(objectMap, "managedIdentityCertificateExpirationTime", (*timeRFC3339)(c.ManagedIdentityCertificateExpirationTime))
...
func (c *ConnectedClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastConnectivityTime":
			...
			c.LastConnectivityTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "managedIdentityCertificateExpirationTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.ManagedIdentityCertificateExpirationTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "offering":
