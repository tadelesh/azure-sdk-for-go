...
func (a ApplyUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "lastUpdateTime", (*timeRFC3339)(a.LastUpdateTime))
...
func (a *ApplyUpdateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastUpdateTime":
			...
			a.LastUpdateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "resourceId":
...
func (u Update) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "notBefore", (*timeRFC3339)(u.NotBefore))
