...
func NewApplyUpdatesClient(con *arm.Connection, subscriptionID string) *ApplyUpdatesClient {
	return &ApplyUpdatesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
