...
func NewMaintenanceConfigurationsForResourceGroupClient(con *arm.Connection, subscriptionID string) *MaintenanceConfigurationsForResourceGroupClient {
	return &MaintenanceConfigurationsForResourceGroupClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
