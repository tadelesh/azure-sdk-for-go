...
func NewPublicMaintenanceConfigurationsClient(con *arm.Connection, subscriptionID string) *PublicMaintenanceConfigurationsClient {
	return &PublicMaintenanceConfigurationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
