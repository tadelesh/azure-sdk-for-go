...
func NewUpdatesClient(con *arm.Connection, subscriptionID string) *UpdatesClient {
	return &UpdatesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
