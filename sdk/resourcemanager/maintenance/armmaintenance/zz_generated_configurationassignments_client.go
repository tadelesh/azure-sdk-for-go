...
func NewConfigurationAssignmentsClient(con *arm.Connection, subscriptionID string) *ConfigurationAssignmentsClient {
	return &ConfigurationAssignmentsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
