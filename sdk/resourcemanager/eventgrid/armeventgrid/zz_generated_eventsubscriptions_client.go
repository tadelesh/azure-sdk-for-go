...
func (client *EventSubscriptionsClient) BeginCreateOrUpdate(ctx context.Context, scope string, eventSubscriptionName string, eventSubscriptionInfo EventSubscription, options *EventSubscriptionsClientBeginCreateOrUpdateOptions) (*armruntime.Poller[EventSubscriptionsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[EventSubscriptionsClientCreateOrUpdateResponse]("EventSubscriptionsClient.CreateOrUpdate", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[EventSubscriptionsClientCreateOrUpdateResponse]("EventSubscriptionsClient.CreateOrUpdate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *EventSubscriptionsClient) BeginDelete(ctx context.Context, scope string, eventSubscriptionName string, options *EventSubscriptionsClientBeginDeleteOptions) (*armruntime.Poller[EventSubscriptionsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[EventSubscriptionsClientDeleteResponse]("EventSubscriptionsClient.Delete", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[EventSubscriptionsClientDeleteResponse]("EventSubscriptionsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *EventSubscriptionsClient) BeginUpdate(ctx context.Context, scope string, eventSubscriptionName string, eventSubscriptionUpdateParameters EventSubscriptionUpdateParameters, options *EventSubscriptionsClientBeginUpdateOptions) (*armruntime.Poller[EventSubscriptionsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[EventSubscriptionsClientUpdateResponse]("EventSubscriptionsClient.Update", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[EventSubscriptionsClientUpdateResponse]("EventSubscriptionsClient.Update", options.ResumeToken, client.pl, nil)
	}
}
