...
func NewResourceChangesClient(con *arm.Connection) *ResourceChangesClient {
	return &ResourceChangesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *ResourceChangesClient) listHandleResponse(resp *http.Response) (ResourceChangesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ChangeList); err != nil {
		return ResourceChangesListResponse{}, err
	}
	return result, nil
}
