...
func NewSerialPortsClient(con *arm.Connection, subscriptionID string) *SerialPortsClient {
	return &SerialPortsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
