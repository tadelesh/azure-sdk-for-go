...
func NewMicrosoftSerialConsoleClient(con *arm.Connection, subscriptionID string) *MicrosoftSerialConsoleClient {
	return &MicrosoftSerialConsoleClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
