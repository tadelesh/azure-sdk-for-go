...
func NewTagRulesClient(con *arm.Connection, subscriptionID string) *TagRulesClient {
	return &TagRulesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *TagRulesClient) listHandleResponse(resp *http.Response) (TagRulesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.MonitoringTagRulesListResponse); err != nil {
		return TagRulesListResponse{}, err
	}
	return result, nil
}
