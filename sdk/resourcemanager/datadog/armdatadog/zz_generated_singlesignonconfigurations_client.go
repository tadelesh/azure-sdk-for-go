...
func NewSingleSignOnConfigurationsClient(con *arm.Connection, subscriptionID string) *SingleSignOnConfigurationsClient {
	return &SingleSignOnConfigurationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SingleSignOnConfigurationsClient) listHandleResponse(resp *http.Response) (SingleSignOnConfigurationsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.DatadogSingleSignOnResourceListResponse); err != nil {
		return SingleSignOnConfigurationsListResponse{}, err
	}
	return result, nil
}
