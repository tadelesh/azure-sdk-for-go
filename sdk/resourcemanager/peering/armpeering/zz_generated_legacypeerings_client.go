...
func NewLegacyPeeringsClient(con *arm.Connection, subscriptionID string) *LegacyPeeringsClient {
	return &LegacyPeeringsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *LegacyPeeringsClient) listHandleResponse(resp *http.Response) (LegacyPeeringsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PeeringListResult); err != nil {
		return LegacyPeeringsListResponse{}, err
	}
	return result, nil
}
