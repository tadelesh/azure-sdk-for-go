...
func NewPeerAsnsClient(con *arm.Connection, subscriptionID string) *PeerAsnsClient {
	return &PeerAsnsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *PeerAsnsClient) listBySubscriptionHandleResponse(resp *http.Response) (PeerAsnsListBySubscriptionResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PeerAsnListResult); err != nil {
		return PeerAsnsListBySubscriptionResponse{}, err
	}
	return result, nil
}
