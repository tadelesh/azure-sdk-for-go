...
func NewPeeringServicePrefixesClient(con *arm.Connection, subscriptionID string) *PeeringServicePrefixesClient {
	return &PeeringServicePrefixesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
