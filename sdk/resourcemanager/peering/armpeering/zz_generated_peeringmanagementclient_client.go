...
func NewPeeringManagementClient(con *arm.Connection, subscriptionID string) *PeeringManagementClient {
	return &PeeringManagementClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
