...
- Function `*FactoriesClientListPager.NextPage` return value(s) have been changed from `(bool)` to `(FactoriesClientListResponse, error)`
- Function `*DataFlowsClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(DataFlowsClientListByFactoryResponse, error)`
- Function `*FactoriesClientListByResourceGroupPager.NextPage` return value(s) have been changed from `(bool)` to `(FactoriesClientListByResourceGroupResponse, error)`
- Function `*DatasetsClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(DatasetsClientListByFactoryResponse, error)`
- Function `*PrivateEndPointConnectionsClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(PrivateEndPointConnectionsClientListByFactoryResponse, error)`
- Function `*ManagedPrivateEndpointsClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(ManagedPrivateEndpointsClientListByFactoryResponse, error)`
- Function `*TriggersClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(TriggersClientListByFactoryResponse, error)`
- Function `*IntegrationRuntimesClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(IntegrationRuntimesClientListByFactoryResponse, error)`
- Function `*DataFlowDebugSessionClientQueryByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(DataFlowDebugSessionClientQueryByFactoryResponse, error)`
- Function `*ManagedVirtualNetworksClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(ManagedVirtualNetworksClientListByFactoryResponse, error)`
- Function `*PipelinesClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(PipelinesClientListByFactoryResponse, error)`
- Function `*LinkedServicesClientListByFactoryPager.NextPage` return value(s) have been changed from `(bool)` to `(LinkedServicesClientListByFactoryResponse, error)`
...
- Field `RawResponse` of struct `TriggersClientStopPollerResponse` has been removed
...
- Field `RawResponse` of struct `DataFlowDebugSessionClientExecuteCommandPollerResponse` has been removed
...
- Field `RawResponse` of struct `TriggersClientUnsubscribeFromEventsPollerResponse` has been removed
...
- Field `RawResponse` of struct `DataFlowDebugSessionClientCreatePollerResponse` has been removed
- Field `RawResponse` of struct `IntegrationRuntimesClientSyncCredentialsResponse` has been removed
- Field `RawResponse` of struct `TriggersClientSubscribeToEventsPollerResponse` has been removed
...
- Field `RawResponse` of struct `TriggersClientStartPollerResponse` has been removed
...
- New function `*ManagedVirtualNetworksClientListByFactoryPager.More() bool`
- New function `*OperationsClientListPager.More() bool`
- New function `*ManagedPrivateEndpointsClientListByFactoryPager.More() bool`
- New function `*IntegrationRuntimesClientListByFactoryPager.More() bool`
...
- New function `*PipelinesClientListByFactoryPager.More() bool`
- New function `*DataFlowDebugSessionClientQueryByFactoryPager.More() bool`
- New function `*TriggersClientListByFactoryPager.More() bool`
- New function `*DatasetsClientListByFactoryPager.More() bool`
- New function `*DataFlowsClientListByFactoryPager.More() bool`
- New function `*LinkedServicesClientListByFactoryPager.More() bool`
- New function `*FactoriesClientListPager.More() bool`
...
- New function `*FactoriesClientListByResourceGroupPager.More() bool`
- New function `GetDataFactoryOperationStatusResponse.MarshalJSON() ([]byte, error)`
- New function `*PrivateEndPointConnectionsClientListByFactoryPager.More() bool`
