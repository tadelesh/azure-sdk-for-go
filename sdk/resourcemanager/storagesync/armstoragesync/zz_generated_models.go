...
func (c CloudEndpointChangeEnumerationActivity) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastUpdatedTimestamp", (*timeRFC3339)(c.LastUpdatedTimestamp))
	...
	populate(objectMap, "startedTimestamp", (*timeRFC3339)(c.StartedTimestamp))
...
func (c *CloudEndpointChangeEnumerationActivity) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastUpdatedTimestamp":
			...
			c.LastUpdatedTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		...
		case "startedTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.StartedTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "statusCode":
...
func (c CloudEndpointLastChangeEnumerationStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "completedTimestamp", (*timeRFC3339)(c.CompletedTimestamp))
	...
	populate(objectMap, "nextRunTimestamp", (*timeRFC3339)(c.NextRunTimestamp))
	populate(objectMap, "startedTimestamp", (*timeRFC3339)(c.StartedTimestamp))
	return json.Marshal(objectMap)
}
...
func (c *CloudEndpointLastChangeEnumerationStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "completedTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.CompletedTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		...
		case "nextRunTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.NextRunTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "startedTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
...
func (c CloudTieringDatePolicyStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "lastUpdatedTimestamp", (*timeRFC3339)(c.LastUpdatedTimestamp))
	populate(objectMap, "tieredFilesMostRecentAccessTimestamp", (*timeRFC3339)(c.TieredFilesMostRecentAccessTimestamp))
	return json.Marshal(objectMap)
}
...
func (c *CloudTieringDatePolicyStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "tieredFilesMostRecentAccessTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.TieredFilesMostRecentAccessTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
func (r RegisteredServerProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "agentVersionExpirationDate", (*timeRFC3339)(r.AgentVersionExpirationDate))
...
func (r *RegisteredServerProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "agentVersionExpirationDate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			r.AgentVersionExpirationDate = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (s ServerEndpointBackgroundDataDownloadActivity) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "startedTimestamp", (*timeRFC3339)(s.StartedTimestamp))
...
func (s *ServerEndpointBackgroundDataDownloadActivity) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "startedTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.StartedTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "timestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
...
func (s ServerEndpointCloudTieringStatus) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "healthLastUpdatedTimestamp", (*timeRFC3339)(s.HealthLastUpdatedTimestamp))
	populate(objectMap, "lastCloudTieringResult", s.LastCloudTieringResult)
	populate(objectMap, "lastSuccessTimestamp", (*timeRFC3339)(s.LastSuccessTimestamp))
	populate(objectMap, "lastUpdatedTimestamp", (*timeRFC3339)(s.LastUpdatedTimestamp))
...
func (s *ServerEndpointCloudTieringStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "healthLastUpdatedTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.HealthLastUpdatedTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		...
		case "lastSuccessTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastSuccessTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastUpdatedTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastUpdatedTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "spaceSavings":
...
func (s ServerEndpointSyncSessionStatus) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastSyncSuccessTimestamp", (*timeRFC3339)(s.LastSyncSuccessTimestamp))
	populate(objectMap, "lastSyncTimestamp", (*timeRFC3339)(s.LastSyncTimestamp))
...
func (s *ServerEndpointSyncSessionStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastSyncSuccessTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastSyncSuccessTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastSyncTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastSyncTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (w WorkflowProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "createdTimestamp", (*timeRFC3339)(w.CreatedTimestamp))
	populate(objectMap, "lastOperationId", w.LastOperationID)
	populate(objectMap, "lastStatusTimestamp", (*timeRFC3339)(w.LastStatusTimestamp))
...
func (w *WorkflowProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			w.CreatedTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		...
		case "lastStatusTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			w.LastStatusTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastStepName":
