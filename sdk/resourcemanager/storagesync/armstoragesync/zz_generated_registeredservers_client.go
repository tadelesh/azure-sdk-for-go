...
func NewRegisteredServersClient(con *arm.Connection, subscriptionID string) *RegisteredServersClient {
	return &RegisteredServersClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
