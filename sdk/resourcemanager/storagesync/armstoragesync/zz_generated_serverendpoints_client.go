...
func NewServerEndpointsClient(con *arm.Connection, subscriptionID string) *ServerEndpointsClient {
	return &ServerEndpointsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
