...
func NewDataStoresClient(con *arm.Connection, subscriptionID string) *DataStoresClient {
	return &DataStoresClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *DataStoresClient) listByDataManagerHandleResponse(resp *http.Response) (DataStoresListByDataManagerResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.DataStoreList); err != nil {
		return DataStoresListByDataManagerResponse{}, err
	}
	return result, nil
}
