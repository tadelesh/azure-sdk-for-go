...
func NewPublicKeysClient(con *arm.Connection, subscriptionID string) *PublicKeysClient {
	return &PublicKeysClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *PublicKeysClient) listByDataManagerHandleResponse(resp *http.Response) (PublicKeysListByDataManagerResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PublicKeyList); err != nil {
		return PublicKeysListByDataManagerResponse{}, err
	}
	return result, nil
}
