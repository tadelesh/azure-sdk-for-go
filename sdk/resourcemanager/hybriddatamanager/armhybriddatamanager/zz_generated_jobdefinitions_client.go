...
func NewJobDefinitionsClient(con *arm.Connection, subscriptionID string) *JobDefinitionsClient {
	return &JobDefinitionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *JobDefinitionsClient) listByDataManagerHandleResponse(resp *http.Response) (JobDefinitionsListByDataManagerResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.JobDefinitionList); err != nil {
		return JobDefinitionsListByDataManagerResponse{}, err
	}
	return result, nil
}
...
func (client *JobDefinitionsClient) listByDataServiceHandleResponse(resp *http.Response) (JobDefinitionsListByDataServiceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.JobDefinitionList); err != nil {
		return JobDefinitionsListByDataServiceResponse{}, err
	}
	return result, nil
}
