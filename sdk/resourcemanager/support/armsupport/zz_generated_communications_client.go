...
func NewCommunicationsClient(con *arm.Connection, subscriptionID string) *CommunicationsClient {
	return &CommunicationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *CommunicationsClient) listHandleResponse(resp *http.Response) (CommunicationsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.CommunicationsListResult); err != nil {
		return CommunicationsListResponse{}, err
	}
	return result, nil
}
