...
func (s SupportTicketDetailsProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "modifiedDate", (*timeRFC3339)(s.ModifiedDate))
	...
	populate(objectMap, "problemStartTime", (*timeRFC3339)(s.ProblemStartTime))
...
func (s *SupportTicketDetailsProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "problemStartTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.ProblemStartTime = (*time.Time)(&aux)
			delete(rawMsg, key)
