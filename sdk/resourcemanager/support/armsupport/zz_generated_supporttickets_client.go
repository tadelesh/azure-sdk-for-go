...
func NewSupportTicketsClient(con *arm.Connection, subscriptionID string) *SupportTicketsClient {
	return &SupportTicketsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SupportTicketsClient) listHandleResponse(resp *http.Response) (SupportTicketsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SupportTicketsListResult); err != nil {
		return SupportTicketsListResponse{}, err
	}
	return result, nil
}
