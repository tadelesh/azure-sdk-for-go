...
func (r RecommendationProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastUpdated", (*timeRFC3339)(r.LastUpdated))
...
func (s SuppressionProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "expirationTimeStamp", (*timeRFC3339)(s.ExpirationTimeStamp))
...
func (s *SuppressionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expirationTimeStamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.ExpirationTimeStamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "suppressionId":
