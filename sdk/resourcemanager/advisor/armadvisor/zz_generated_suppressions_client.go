...
func NewSuppressionsClient(con *arm.Connection, subscriptionID string) *SuppressionsClient {
	return &SuppressionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SuppressionsClient) listHandleResponse(resp *http.Response) (SuppressionsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SuppressionContractListResult); err != nil {
		return SuppressionsListResponse{}, err
	}
	return result, nil
}
