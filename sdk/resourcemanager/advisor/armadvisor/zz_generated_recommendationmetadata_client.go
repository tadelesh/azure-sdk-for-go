...
func NewRecommendationMetadataClient(con *arm.Connection) *RecommendationMetadataClient {
	return &RecommendationMetadataClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *RecommendationMetadataClient) listHandleResponse(resp *http.Response) (RecommendationMetadataListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.MetadataEntityListResult); err != nil {
		return RecommendationMetadataListResponse{}, err
	}
	return result, nil
}
