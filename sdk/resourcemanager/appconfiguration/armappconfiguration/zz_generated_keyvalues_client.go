...
func NewKeyValuesClient(con *arm.Connection, subscriptionID string) *KeyValuesClient {
	return &KeyValuesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *KeyValuesClient) listByConfigurationStoreHandleResponse(resp *http.Response) (KeyValuesListByConfigurationStoreResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.KeyValueListResult); err != nil {
		return KeyValuesListByConfigurationStoreResponse{}, err
	}
	return result, nil
}
