...
func ExampleAccessReviewInstanceContactedReviewersClient_List() {
	...
	client := armauthorization.NewAccessReviewInstanceContactedReviewersClient("<subscription-id>", cred, nil)
