...
func NewAccessReviewHistoryDefinitionsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *AccessReviewHistoryDefinitionsClient {
	if options == nil {
...
// method.
func (client *AccessReviewHistoryDefinitionsClient) List(options *AccessReviewHistoryDefinitionsClientListOptions) *AccessReviewHistoryDefinitionsClientListPager {
	return &AccessReviewHistoryDefinitionsClientListPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listCreateRequest(ctx, options)
		},
		advancer: func(ctx context.Context, resp AccessReviewHistoryDefinitionsClientListResponse) (*policy.Request, error) {
			return runtime.NewRequest(ctx, http.MethodGet, *resp.AccessReviewHistoryDefinitionListResult.NextLink)
		},
	}
}
