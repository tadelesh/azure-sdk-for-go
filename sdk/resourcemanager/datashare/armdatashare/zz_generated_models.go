...
func (c ConsumerInvitationProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "respondedAt", (*timeRFC3339)(c.RespondedAt))
	populate(objectMap, "sentAt", (*timeRFC3339)(c.SentAt))
...
func (c *ConsumerInvitationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "respondedAt":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.RespondedAt = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "sentAt":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.SentAt = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "shareName":
...
func (e EmailRegistration) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "activationExpirationDate", (*timeRFC3339)(e.ActivationExpirationDate))
...
func (e *EmailRegistration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "activationExpirationDate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			e.ActivationExpirationDate = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "email":
...
func (i InvitationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "expirationDate", (*timeRFC3339)(i.ExpirationDate))
	populate(objectMap, "invitationId", i.InvitationID)
	populate(objectMap, "invitationStatus", i.InvitationStatus)
	populate(objectMap, "respondedAt", (*timeRFC3339)(i.RespondedAt))
	populate(objectMap, "sentAt", (*timeRFC3339)(i.SentAt))
...
func (i *InvitationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expirationDate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			i.ExpirationDate = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "invitationId":
		...
		case "respondedAt":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			i.RespondedAt = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "sentAt":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			i.SentAt = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (p ProviderShareSubscriptionProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "createdAt", (*timeRFC3339)(p.CreatedAt))
	populate(objectMap, "expirationDate", (*timeRFC3339)(p.ExpirationDate))
	...
	populate(objectMap, "sharedAt", (*timeRFC3339)(p.SharedAt))
	return json.Marshal(objectMap)
}
...
func (p *ProviderShareSubscriptionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdAt":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			p.CreatedAt = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "expirationDate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			p.ExpirationDate = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "providerEmail":
...
func (s ScheduledSourceShareSynchronizationSettingProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "synchronizationTime", (*timeRFC3339)(s.SynchronizationTime))
	return json.Marshal(objectMap)
}
...
func (s *ScheduledSourceShareSynchronizationSettingProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "synchronizationTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.SynchronizationTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
