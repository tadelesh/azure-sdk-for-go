...
func NewDataSetsClient(con *arm.Connection, subscriptionID string) *DataSetsClient {
	return &DataSetsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *DataSetsClient) listByShareHandleResponse(resp *http.Response) (DataSetsListByShareResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.DataSetList); err != nil {
		return DataSetsListByShareResponse{}, err
	}
	return result, nil
}
