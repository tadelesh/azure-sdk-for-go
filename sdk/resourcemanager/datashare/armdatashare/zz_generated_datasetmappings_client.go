...
func NewDataSetMappingsClient(con *arm.Connection, subscriptionID string) *DataSetMappingsClient {
	return &DataSetMappingsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *DataSetMappingsClient) listByShareSubscriptionHandleResponse(resp *http.Response) (DataSetMappingsListByShareSubscriptionResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.DataSetMappingList); err != nil {
		return DataSetMappingsListByShareSubscriptionResponse{}, err
	}
	return result, nil
}
