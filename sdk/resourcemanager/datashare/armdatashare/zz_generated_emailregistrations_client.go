...
func NewEmailRegistrationsClient(con *arm.Connection) *EmailRegistrationsClient {
	return &EmailRegistrationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
