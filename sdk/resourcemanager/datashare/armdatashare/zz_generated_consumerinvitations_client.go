...
func NewConsumerInvitationsClient(con *arm.Connection) *ConsumerInvitationsClient {
	return &ConsumerInvitationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *ConsumerInvitationsClient) listInvitationsHandleResponse(resp *http.Response) (ConsumerInvitationsListInvitationsResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ConsumerInvitationList); err != nil {
		return ConsumerInvitationsListInvitationsResponse{}, err
	}
	return result, nil
}
