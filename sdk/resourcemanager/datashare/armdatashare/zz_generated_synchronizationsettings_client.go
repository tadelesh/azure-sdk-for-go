...
func NewSynchronizationSettingsClient(con *arm.Connection, subscriptionID string) *SynchronizationSettingsClient {
	return &SynchronizationSettingsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SynchronizationSettingsClient) listByShareHandleResponse(resp *http.Response) (SynchronizationSettingsListByShareResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SynchronizationSettingList); err != nil {
		return SynchronizationSettingsListByShareResponse{}, err
	}
	return result, nil
}
