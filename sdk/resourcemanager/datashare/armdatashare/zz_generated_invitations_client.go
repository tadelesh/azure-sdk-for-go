...
func NewInvitationsClient(con *arm.Connection, subscriptionID string) *InvitationsClient {
	return &InvitationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *InvitationsClient) listByShareHandleResponse(resp *http.Response) (InvitationsListByShareResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.InvitationList); err != nil {
		return InvitationsListByShareResponse{}, err
	}
	return result, nil
}
