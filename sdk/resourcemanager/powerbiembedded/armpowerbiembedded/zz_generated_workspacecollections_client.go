...
func NewWorkspaceCollectionsClient(con *arm.Connection, subscriptionID string) *WorkspaceCollectionsClient {
	return &WorkspaceCollectionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
