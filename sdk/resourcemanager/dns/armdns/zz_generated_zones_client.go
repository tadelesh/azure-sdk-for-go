...
func NewZonesClient(con *arm.Connection, subscriptionID string) *ZonesClient {
	return &ZonesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ZonesClient) listByResourceGroupHandleResponse(resp *http.Response) (ZonesListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ZoneListResult); err != nil {
		return ZonesListByResourceGroupResponse{}, err
	}
	return result, nil
}
