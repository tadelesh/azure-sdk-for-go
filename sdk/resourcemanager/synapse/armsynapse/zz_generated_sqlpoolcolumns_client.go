...
func NewSQLPoolColumnsClient(con *arm.Connection, subscriptionID string) *SQLPoolColumnsClient {
	return &SQLPoolColumnsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
