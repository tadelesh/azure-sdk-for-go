...
func NewIPFirewallRulesClient(con *arm.Connection, subscriptionID string) *IPFirewallRulesClient {
	return &IPFirewallRulesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *IPFirewallRulesClient) listByWorkspaceHandleResponse(resp *http.Response) (IPFirewallRulesListByWorkspaceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.IPFirewallRuleInfoListResult); err != nil {
		return IPFirewallRulesListByWorkspaceResponse{}, err
	}
	return result, nil
}
