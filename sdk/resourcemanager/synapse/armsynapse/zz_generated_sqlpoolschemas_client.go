...
func NewSQLPoolSchemasClient(con *arm.Connection, subscriptionID string) *SQLPoolSchemasClient {
	return &SQLPoolSchemasClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SQLPoolSchemasClient) listHandleResponse(resp *http.Response) (SQLPoolSchemasListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SQLPoolSchemaListResult); err != nil {
		return SQLPoolSchemasListResponse{}, err
	}
	return result, nil
}
