...
func NewBigDataPoolsClient(con *arm.Connection, subscriptionID string) *BigDataPoolsClient {
	return &BigDataPoolsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *BigDataPoolsClient) listByWorkspaceHandleResponse(resp *http.Response) (BigDataPoolsListByWorkspaceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.BigDataPoolResourceInfoListResult); err != nil {
		return BigDataPoolsListByWorkspaceResponse{}, err
	}
	return result, nil
}
