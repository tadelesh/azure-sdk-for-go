...
func NewSQLPoolReplicationLinksClient(con *arm.Connection, subscriptionID string) *SQLPoolReplicationLinksClient {
	return &SQLPoolReplicationLinksClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SQLPoolReplicationLinksClient) listHandleResponse(resp *http.Response) (SQLPoolReplicationLinksListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ReplicationLinkListResult); err != nil {
		return SQLPoolReplicationLinksListResponse{}, err
	}
	return result, nil
}
