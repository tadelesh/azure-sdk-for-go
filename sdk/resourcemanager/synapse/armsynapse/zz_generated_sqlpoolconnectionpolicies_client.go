...
func NewSQLPoolConnectionPoliciesClient(con *arm.Connection, subscriptionID string) *SQLPoolConnectionPoliciesClient {
	return &SQLPoolConnectionPoliciesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
