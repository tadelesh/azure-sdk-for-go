...
func NewSparkConfigurationsClient(con *arm.Connection, subscriptionID string) *SparkConfigurationsClient {
	return &SparkConfigurationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SparkConfigurationsClient) listByWorkspaceHandleResponse(resp *http.Response) (SparkConfigurationsListByWorkspaceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SparkConfigurationListResponse); err != nil {
		return SparkConfigurationsListByWorkspaceResponse{}, err
	}
	return result, nil
}
