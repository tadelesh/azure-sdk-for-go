...
func NewIntegrationRuntimeNodeIPAddressClient(con *arm.Connection, subscriptionID string) *IntegrationRuntimeNodeIPAddressClient {
	return &IntegrationRuntimeNodeIPAddressClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
