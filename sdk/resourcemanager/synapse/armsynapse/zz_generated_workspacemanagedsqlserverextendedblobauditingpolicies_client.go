...
func NewWorkspaceManagedSQLServerExtendedBlobAuditingPoliciesClient(con *arm.Connection, subscriptionID string) *WorkspaceManagedSQLServerExtendedBlobAuditingPoliciesClient {
	return &WorkspaceManagedSQLServerExtendedBlobAuditingPoliciesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *WorkspaceManagedSQLServerExtendedBlobAuditingPoliciesClient) listByWorkspaceHandleResponse(resp *http.Response) (WorkspaceManagedSQLServerExtendedBlobAuditingPoliciesListByWorkspaceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ExtendedServerBlobAuditingPolicyListResult); err != nil {
		return WorkspaceManagedSQLServerExtendedBlobAuditingPoliciesListByWorkspaceResponse{}, err
	}
	return result, nil
}
