...
func NewSQLPoolMetadataSyncConfigsClient(con *arm.Connection, subscriptionID string) *SQLPoolMetadataSyncConfigsClient {
	return &SQLPoolMetadataSyncConfigsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
