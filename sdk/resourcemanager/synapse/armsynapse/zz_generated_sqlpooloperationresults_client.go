...
func NewSQLPoolOperationResultsClient(con *arm.Connection, subscriptionID string) *SQLPoolOperationResultsClient {
	return &SQLPoolOperationResultsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
