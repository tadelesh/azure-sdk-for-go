...
func NewWorkspaceManagedSQLServerEncryptionProtectorClient(con *arm.Connection, subscriptionID string) *WorkspaceManagedSQLServerEncryptionProtectorClient {
	return &WorkspaceManagedSQLServerEncryptionProtectorClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *WorkspaceManagedSQLServerEncryptionProtectorClient) listHandleResponse(resp *http.Response) (WorkspaceManagedSQLServerEncryptionProtectorListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.EncryptionProtectorListResult); err != nil {
		return WorkspaceManagedSQLServerEncryptionProtectorListResponse{}, err
	}
	return result, nil
}
