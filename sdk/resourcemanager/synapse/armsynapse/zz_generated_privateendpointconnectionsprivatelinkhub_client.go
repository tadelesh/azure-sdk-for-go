...
func NewPrivateEndpointConnectionsPrivateLinkHubClient(con *arm.Connection, subscriptionID string) *PrivateEndpointConnectionsPrivateLinkHubClient {
	return &PrivateEndpointConnectionsPrivateLinkHubClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *PrivateEndpointConnectionsPrivateLinkHubClient) listHandleResponse(resp *http.Response) (PrivateEndpointConnectionsPrivateLinkHubListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PrivateEndpointConnectionForPrivateLinkHubResourceCollectionResponse); err != nil {
		return PrivateEndpointConnectionsPrivateLinkHubListResponse{}, err
	}
	return result, nil
}
