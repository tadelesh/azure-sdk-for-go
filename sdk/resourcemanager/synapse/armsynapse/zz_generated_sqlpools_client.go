...
func NewSQLPoolsClient(con *arm.Connection, subscriptionID string) *SQLPoolsClient {
	return &SQLPoolsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SQLPoolsClient) listByWorkspaceHandleResponse(resp *http.Response) (SQLPoolsListByWorkspaceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SQLPoolInfoListResult); err != nil {
		return SQLPoolsListByWorkspaceResponse{}, err
	}
	return result, nil
}
