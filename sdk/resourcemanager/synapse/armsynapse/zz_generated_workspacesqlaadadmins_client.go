...
func NewWorkspaceSQLAADAdminsClient(con *arm.Connection, subscriptionID string) *WorkspaceSQLAADAdminsClient {
	return &WorkspaceSQLAADAdminsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
