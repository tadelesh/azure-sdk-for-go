...
func NewIntegrationRuntimeMonitoringDataClient(con *arm.Connection, subscriptionID string) *IntegrationRuntimeMonitoringDataClient {
	return &IntegrationRuntimeMonitoringDataClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
