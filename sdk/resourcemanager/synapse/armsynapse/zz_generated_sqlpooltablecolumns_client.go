...
func NewSQLPoolTableColumnsClient(con *arm.Connection, subscriptionID string) *SQLPoolTableColumnsClient {
	return &SQLPoolTableColumnsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SQLPoolTableColumnsClient) listByTableNameHandleResponse(resp *http.Response) (SQLPoolTableColumnsListByTableNameResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SQLPoolColumnListResult); err != nil {
		return SQLPoolTableColumnsListByTableNameResponse{}, err
	}
	return result, nil
}
