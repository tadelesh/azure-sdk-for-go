...
func NewSQLPoolSensitivityLabelsClient(con *arm.Connection, subscriptionID string) *SQLPoolSensitivityLabelsClient {
	return &SQLPoolSensitivityLabelsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SQLPoolSensitivityLabelsClient) listCurrentHandleResponse(resp *http.Response) (SQLPoolSensitivityLabelsListCurrentResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SensitivityLabelListResult); err != nil {
		return SQLPoolSensitivityLabelsListCurrentResponse{}, err
	}
	return result, nil
}
...
func (client *SQLPoolSensitivityLabelsClient) listRecommendedHandleResponse(resp *http.Response) (SQLPoolSensitivityLabelsListRecommendedResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SensitivityLabelListResult); err != nil {
		return SQLPoolSensitivityLabelsListRecommendedResponse{}, err
	}
	return result, nil
}
