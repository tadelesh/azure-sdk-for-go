...
func NewSQLPoolWorkloadGroupClient(con *arm.Connection, subscriptionID string) *SQLPoolWorkloadGroupClient {
	return &SQLPoolWorkloadGroupClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SQLPoolWorkloadGroupClient) listHandleResponse(resp *http.Response) (SQLPoolWorkloadGroupListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.WorkloadGroupListResult); err != nil {
		return SQLPoolWorkloadGroupListResponse{}, err
	}
	return result, nil
}
