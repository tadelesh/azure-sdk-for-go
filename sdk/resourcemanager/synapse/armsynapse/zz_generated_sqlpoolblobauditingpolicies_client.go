...
func NewSQLPoolBlobAuditingPoliciesClient(con *arm.Connection, subscriptionID string) *SQLPoolBlobAuditingPoliciesClient {
	return &SQLPoolBlobAuditingPoliciesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}

// CreateOrUpdate - Creates or updates a SQL pool's blob auditing policy.
// If the operation fails it returns a generic error.
func (client *SQLPoolBlobAuditingPoliciesClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, blobAuditingPolicyName Enum10, parameters SQLPoolBlobAuditingPolicy, options *SQLPoolBlobAuditingPoliciesCreateOrUpdateOptions) (SQLPoolBlobAuditingPoliciesCreateOrUpdateResponse, error) {
...
// If the operation fails it returns a generic error.
func (client *SQLPoolBlobAuditingPoliciesClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, blobAuditingPolicyName Enum10, options *SQLPoolBlobAuditingPoliciesGetOptions) (SQLPoolBlobAuditingPoliciesGetResponse, error) {
...
func (client *SQLPoolBlobAuditingPoliciesClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sqlPoolName string, blobAuditingPolicyName Enum10, options *SQLPoolBlobAuditingPoliciesGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/auditingSettings/{blobAuditingPolicyName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SQLPoolBlobAuditingPoliciesClient) listBySQLPoolHandleResponse(resp *http.Response) (SQLPoolBlobAuditingPoliciesListBySQLPoolResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SQLPoolBlobAuditingPolicyListResult); err != nil {
		return SQLPoolBlobAuditingPoliciesListBySQLPoolResponse{}, err
	}
	return result, nil
}
