...
func NewAzureADOnlyAuthenticationsClient(con *arm.Connection, subscriptionID string) *AzureADOnlyAuthenticationsClient {
	return &AzureADOnlyAuthenticationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *AzureADOnlyAuthenticationsClient) listHandleResponse(resp *http.Response) (AzureADOnlyAuthenticationsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.AzureADOnlyAuthenticationListResult); err != nil {
		return AzureADOnlyAuthenticationsListResponse{}, err
	}
	return result, nil
}
