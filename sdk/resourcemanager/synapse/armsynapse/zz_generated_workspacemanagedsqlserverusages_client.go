...
func NewWorkspaceManagedSQLServerUsagesClient(con *arm.Connection, subscriptionID string) *WorkspaceManagedSQLServerUsagesClient {
	return &WorkspaceManagedSQLServerUsagesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *WorkspaceManagedSQLServerUsagesClient) listHandleResponse(resp *http.Response) (WorkspaceManagedSQLServerUsagesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ServerUsageListResult); err != nil {
		return WorkspaceManagedSQLServerUsagesListResponse{}, err
	}
	return result, nil
}
