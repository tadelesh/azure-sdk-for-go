...
func NewSQLPoolRestorePointsClient(con *arm.Connection, subscriptionID string) *SQLPoolRestorePointsClient {
	return &SQLPoolRestorePointsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SQLPoolRestorePointsClient) listHandleResponse(resp *http.Response) (SQLPoolRestorePointsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RestorePointListResult); err != nil {
		return SQLPoolRestorePointsListResponse{}, err
	}
	return result, nil
}
