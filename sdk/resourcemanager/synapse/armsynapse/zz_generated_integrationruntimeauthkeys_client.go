...
func NewIntegrationRuntimeAuthKeysClient(con *arm.Connection, subscriptionID string) *IntegrationRuntimeAuthKeysClient {
	return &IntegrationRuntimeAuthKeysClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
