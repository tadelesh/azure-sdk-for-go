...
func NewSQLPoolWorkloadClassifierClient(con *arm.Connection, subscriptionID string) *SQLPoolWorkloadClassifierClient {
	return &SQLPoolWorkloadClassifierClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SQLPoolWorkloadClassifierClient) listHandleResponse(resp *http.Response) (SQLPoolWorkloadClassifierListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.WorkloadClassifierListResult); err != nil {
		return SQLPoolWorkloadClassifierListResponse{}, err
	}
	return result, nil
}
