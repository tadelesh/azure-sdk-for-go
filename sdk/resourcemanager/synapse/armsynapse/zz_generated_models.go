...
func (a AzureADOnlyAuthenticationProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "creationDate", (*timeRFC3339)(a.CreationDate))
...
func (b BigDataPoolResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "creationDate", (*timeRFC3339)(b.CreationDate))
	...
	populate(objectMap, "lastSucceededTimestamp", (*timeRFC3339)(b.LastSucceededTimestamp))
...
func (b *BigDataPoolResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastSucceededTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			b.LastSucceededTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (l LibraryInfo) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "uploadedTimestamp", (*timeRFC3339)(l.UploadedTimestamp))
	return json.Marshal(objectMap)
}
...
func (l LibraryRequirements) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "time", (*timeRFC3339)(l.Time))
	return json.Marshal(objectMap)
}
...
func (l LinkedIntegrationRuntime) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createTime", (*timeRFC3339)(l.CreateTime))
...
func (m ManagedIntegrationRuntimeStatusTypeProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createTime", (*timeRFC3339)(m.CreateTime))
...
func (q QueryInterval) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "intervalStartTime", (*timeRFC3339)(q.IntervalStartTime))
...
func (q *QueryInterval) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "intervalStartTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			q.IntervalStartTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "metrics":
...
func (s SQLPoolResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "sourceDatabaseDeletionDate", (*timeRFC3339)(s.SourceDatabaseDeletionDate))
...
func (s *SQLPoolResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "sourceDatabaseDeletionDate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.SourceDatabaseDeletionDate = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (s SelfHostedIntegrationRuntimeNode) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastConnectTime", (*timeRFC3339)(s.LastConnectTime))
	populate(objectMap, "lastEndUpdateTime", (*timeRFC3339)(s.LastEndUpdateTime))
	populate(objectMap, "lastStartTime", (*timeRFC3339)(s.LastStartTime))
	populate(objectMap, "lastStartUpdateTime", (*timeRFC3339)(s.LastStartUpdateTime))
	populate(objectMap, "lastStopTime", (*timeRFC3339)(s.LastStopTime))
	...
	populate(objectMap, "registerTime", (*timeRFC3339)(s.RegisterTime))
	populate(objectMap, "status", s.Status)
...
func (s *SelfHostedIntegrationRuntimeNode) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastConnectTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastConnectTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastEndUpdateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastEndUpdateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastStartTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastStartTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastStartUpdateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastStartUpdateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastStopTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastStopTime = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (s SelfHostedIntegrationRuntimeStatusTypeProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "autoUpdateETA", (*timeRFC3339)(s.AutoUpdateETA))
	populate(objectMap, "capabilities", s.Capabilities)
	populate(objectMap, "createTime", (*timeRFC3339)(s.CreateTime))
	...
	populate(objectMap, "scheduledUpdateDate", (*timeRFC3339)(s.ScheduledUpdateDate))
...
func (s *SelfHostedIntegrationRuntimeStatusTypeProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "scheduledUpdateDate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.ScheduledUpdateDate = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "serviceUrls":
...
func (t TopQueries) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "observationEndTime", (*timeRFC3339)(t.ObservationEndTime))
	populate(objectMap, "observationStartTime", (*timeRFC3339)(t.ObservationStartTime))
...
func (t *TopQueries) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "observationEndTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			t.ObservationEndTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "observationStartTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			t.ObservationStartTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "observedMetric":
