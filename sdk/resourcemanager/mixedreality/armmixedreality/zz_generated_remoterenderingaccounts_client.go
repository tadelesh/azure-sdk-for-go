...
func NewRemoteRenderingAccountsClient(con *arm.Connection, subscriptionID string) *RemoteRenderingAccountsClient {
	return &RemoteRenderingAccountsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *RemoteRenderingAccountsClient) listByResourceGroupHandleResponse(resp *http.Response) (RemoteRenderingAccountsListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RemoteRenderingAccountPage); err != nil {
		return RemoteRenderingAccountsListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
func (client *RemoteRenderingAccountsClient) listBySubscriptionHandleResponse(resp *http.Response) (RemoteRenderingAccountsListBySubscriptionResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RemoteRenderingAccountPage); err != nil {
		return RemoteRenderingAccountsListBySubscriptionResponse{}, err
	}
	return result, nil
}
