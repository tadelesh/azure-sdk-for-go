...
func NewContainersClient(con *arm.Connection, subscriptionID string) *ContainersClient {
	return &ContainersClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
