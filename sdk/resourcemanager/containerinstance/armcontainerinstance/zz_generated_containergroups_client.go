...
func NewContainerGroupsClient(con *arm.Connection, subscriptionID string) *ContainerGroupsClient {
	return &ContainerGroupsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ContainerGroupsClient) listHandleResponse(resp *http.Response) (ContainerGroupsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ContainerGroupListResult); err != nil {
		return ContainerGroupsListResponse{}, err
	}
	return result, nil
}
...
func (client *ContainerGroupsClient) listByResourceGroupHandleResponse(resp *http.Response) (ContainerGroupsListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ContainerGroupListResult); err != nil {
		return ContainerGroupsListByResourceGroupResponse{}, err
	}
	return result, nil
}
