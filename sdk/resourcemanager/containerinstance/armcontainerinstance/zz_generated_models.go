...
func (c ContainerState) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "finishTime", (*timeRFC3339)(c.FinishTime))
...
func (e Event) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "firstTimestamp", (*timeRFC3339)(e.FirstTimestamp))
	populate(objectMap, "lastTimestamp", (*timeRFC3339)(e.LastTimestamp))
...
func (e *Event) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "firstTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			e.FirstTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastTimestamp":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			e.LastTimestamp = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "message":
