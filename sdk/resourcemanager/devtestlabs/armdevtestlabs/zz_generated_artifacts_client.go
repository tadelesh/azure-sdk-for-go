...
func NewArtifactsClient(con *arm.Connection, subscriptionID string) *ArtifactsClient {
	return &ArtifactsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ArtifactsClient) listHandleResponse(resp *http.Response) (ArtifactsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ArtifactList); err != nil {
		return ArtifactsListResponse{}, err
	}
	return result, nil
}
