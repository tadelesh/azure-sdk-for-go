...
func NewServiceFabricSchedulesClient(con *arm.Connection, subscriptionID string) *ServiceFabricSchedulesClient {
	return &ServiceFabricSchedulesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ServiceFabricSchedulesClient) listHandleResponse(resp *http.Response) (ServiceFabricSchedulesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ScheduleList); err != nil {
		return ServiceFabricSchedulesListResponse{}, err
	}
	return result, nil
}
