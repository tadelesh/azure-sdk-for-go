...
func NewSchedulesClient(con *arm.Connection, subscriptionID string) *SchedulesClient {
	return &SchedulesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SchedulesClient) listHandleResponse(resp *http.Response) (SchedulesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ScheduleList); err != nil {
		return SchedulesListResponse{}, err
	}
	return result, nil
}
...
func (client *SchedulesClient) listApplicableHandleResponse(resp *http.Response) (SchedulesListApplicableResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ScheduleList); err != nil {
		return SchedulesListApplicableResponse{}, err
	}
	return result, nil
}
