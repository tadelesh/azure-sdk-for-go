...
func NewVirtualMachineSchedulesClient(con *arm.Connection, subscriptionID string) *VirtualMachineSchedulesClient {
	return &VirtualMachineSchedulesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *VirtualMachineSchedulesClient) listHandleResponse(resp *http.Response) (VirtualMachineSchedulesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ScheduleList); err != nil {
		return VirtualMachineSchedulesListResponse{}, err
	}
	return result, nil
}
