...
func NewArmTemplatesClient(con *arm.Connection, subscriptionID string) *ArmTemplatesClient {
	return &ArmTemplatesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ArmTemplatesClient) listHandleResponse(resp *http.Response) (ArmTemplatesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ArmTemplateList); err != nil {
		return ArmTemplatesListResponse{}, err
	}
	return result, nil
}
