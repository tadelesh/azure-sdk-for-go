...
func NewServiceFabricsClient(con *arm.Connection, subscriptionID string) *ServiceFabricsClient {
	return &ServiceFabricsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ServiceFabricsClient) listHandleResponse(resp *http.Response) (ServiceFabricsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ServiceFabricList); err != nil {
		return ServiceFabricsListResponse{}, err
	}
	return result, nil
}
