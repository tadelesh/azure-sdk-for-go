...
func NewCustomImagesClient(con *arm.Connection, subscriptionID string) *CustomImagesClient {
	return &CustomImagesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *CustomImagesClient) listHandleResponse(resp *http.Response) (CustomImagesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.CustomImageList); err != nil {
		return CustomImagesListResponse{}, err
	}
	return result, nil
}
