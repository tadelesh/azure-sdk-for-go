...
func NewFormulasClient(con *arm.Connection, subscriptionID string) *FormulasClient {
	return &FormulasClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *FormulasClient) listHandleResponse(resp *http.Response) (FormulasListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.FormulaList); err != nil {
		return FormulasListResponse{}, err
	}
	return result, nil
}
