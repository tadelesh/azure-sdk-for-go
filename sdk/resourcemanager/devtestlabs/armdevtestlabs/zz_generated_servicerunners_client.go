...
func NewServiceRunnersClient(con *arm.Connection, subscriptionID string) *ServiceRunnersClient {
	return &ServiceRunnersClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
