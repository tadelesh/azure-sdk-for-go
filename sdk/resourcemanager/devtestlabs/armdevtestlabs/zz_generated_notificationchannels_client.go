...
func NewNotificationChannelsClient(con *arm.Connection, subscriptionID string) *NotificationChannelsClient {
	return &NotificationChannelsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *NotificationChannelsClient) listHandleResponse(resp *http.Response) (NotificationChannelsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.NotificationChannelList); err != nil {
		return NotificationChannelsListResponse{}, err
	}
	return result, nil
}
