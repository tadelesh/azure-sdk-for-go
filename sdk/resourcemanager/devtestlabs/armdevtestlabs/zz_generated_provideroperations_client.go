...
func NewProviderOperationsClient(con *arm.Connection) *ProviderOperationsClient {
	return &ProviderOperationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *ProviderOperationsClient) listHandleResponse(resp *http.Response) (ProviderOperationsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ProviderOperationResult); err != nil {
		return ProviderOperationsListResponse{}, err
	}
	return result, nil
}
