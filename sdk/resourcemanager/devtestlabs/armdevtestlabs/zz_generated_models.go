...
func (a ArmTemplateProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "createdDate", (*timeRFC3339)(a.CreatedDate))
...
func (a ArtifactInstallProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "installTime", (*timeRFC3339)(a.InstallTime))
...
func (c CustomImageProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "creationDate", (*timeRFC3339)(c.CreationDate))
...
func (d DiskProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createdDate", (*timeRFC3339)(d.CreatedDate))
...
func (e ExportResourceUsageParameters) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "usageStartDate", (*timeRFC3339)(e.UsageStartDate))
	return json.Marshal(objectMap)
}
...
func (e *ExportResourceUsageParameters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "usageStartDate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			e.UsageStartDate = (*time.Time)(&aux)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
func (f FormulaProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "creationDate", (*timeRFC3339)(f.CreationDate))
...
func (g GalleryImageProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "createdDate", (*timeRFC3339)(g.CreatedDate))
...
func (l LabCostProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createdDate", (*timeRFC3339)(l.CreatedDate))
	populate(objectMap, "currencyCode", l.CurrencyCode)
	populate(objectMap, "endDateTime", (*timeRFC3339)(l.EndDateTime))
	...
	populate(objectMap, "startDateTime", (*timeRFC3339)(l.StartDateTime))
...
func (n NotificationChannelProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createdDate", (*timeRFC3339)(n.CreatedDate))
...
func (p PolicyProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createdDate", (*timeRFC3339)(p.CreatedDate))
...
func (t TargetCostProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "cycleEndDateTime", (*timeRFC3339)(t.CycleEndDateTime))
	populate(objectMap, "cycleStartDateTime", (*timeRFC3339)(t.CycleStartDateTime))
...
func (t *TargetCostProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "cycleEndDateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			t.CycleEndDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "cycleStartDateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			t.CycleStartDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "cycleType":
...
func (u UserProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createdDate", (*timeRFC3339)(u.CreatedDate))
...
func (v VirtualNetworkProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "createdDate", (*timeRFC3339)(v.CreatedDate))
