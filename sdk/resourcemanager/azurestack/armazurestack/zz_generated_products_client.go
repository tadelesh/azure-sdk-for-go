...
func NewProductsClient(con *arm.Connection, subscriptionID string) *ProductsClient {
	return &ProductsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
