...
func NewCustomerSubscriptionsClient(con *arm.Connection, subscriptionID string) *CustomerSubscriptionsClient {
	return &CustomerSubscriptionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *CustomerSubscriptionsClient) listHandleResponse(resp *http.Response) (CustomerSubscriptionsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.CustomerSubscriptionList); err != nil {
		return CustomerSubscriptionsListResponse{}, err
	}
	return result, nil
}
