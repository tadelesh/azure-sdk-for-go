...
// LinkedSubscriptionsClientCreateOrUpdateOptions contains the optional parameters for the LinkedSubscriptionsClient.CreateOrUpdate
// method.
type LinkedSubscriptionsClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// LinkedSubscriptionsClientDeleteOptions contains the optional parameters for the LinkedSubscriptionsClient.Delete method.
type LinkedSubscriptionsClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// LinkedSubscriptionsClientGetOptions contains the optional parameters for the LinkedSubscriptionsClient.Get method.
type LinkedSubscriptionsClientGetOptions struct {
	// placeholder for future optional parameters
}

// LinkedSubscriptionsClientListByResourceGroupOptions contains the optional parameters for the LinkedSubscriptionsClient.ListByResourceGroup
// method.
type LinkedSubscriptionsClientListByResourceGroupOptions struct {
	// placeholder for future optional parameters
}

// LinkedSubscriptionsClientListBySubscriptionOptions contains the optional parameters for the LinkedSubscriptionsClient.ListBySubscription
// method.
type LinkedSubscriptionsClientListBySubscriptionOptions struct {
	// placeholder for future optional parameters
}

// LinkedSubscriptionsClientUpdateOptions contains the optional parameters for the LinkedSubscriptionsClient.Update method.
type LinkedSubscriptionsClientUpdateOptions struct {
	// placeholder for future optional parameters
}
