...
func NewRegistrationsClient(con *arm.Connection, subscriptionID string) *RegistrationsClient {
	return &RegistrationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *RegistrationsClient) listHandleResponse(resp *http.Response) (RegistrationsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RegistrationList); err != nil {
		return RegistrationsListResponse{}, err
	}
	return result, nil
}
...
func (client *RegistrationsClient) listBySubscriptionHandleResponse(resp *http.Response) (RegistrationsListBySubscriptionResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RegistrationList); err != nil {
		return RegistrationsListBySubscriptionResponse{}, err
	}
	return result, nil
}
