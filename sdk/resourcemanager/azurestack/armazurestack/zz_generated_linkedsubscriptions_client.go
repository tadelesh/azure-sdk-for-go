...
func NewLinkedSubscriptionsClient(con *arm.Connection, subscriptionID string) *LinkedSubscriptionsClient {
	return &LinkedSubscriptionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *LinkedSubscriptionsClient) listByResourceGroupHandleResponse(resp *http.Response) (LinkedSubscriptionsListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.LinkedSubscriptionsList); err != nil {
		return LinkedSubscriptionsListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
func (client *LinkedSubscriptionsClient) listBySubscriptionHandleResponse(resp *http.Response) (LinkedSubscriptionsListBySubscriptionResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.LinkedSubscriptionsList); err != nil {
		return LinkedSubscriptionsListBySubscriptionResponse{}, err
	}
	return result, nil
}
