...
func (a *AccountProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "description":
			...
			delete(rawMsg, key)
		case "discoveryUri":
			err = unpopulate(val, &a.DiscoveryURI)
			delete(rawMsg, key)
		case "friendlyName":
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "seats":
			err = unpopulate(val, &a.Seats)
			delete(rawMsg, key)
		case "storageAccount":
			err = unpopulate(val, &a.StorageAccount)
			delete(rawMsg, key)
		case "vsoAccountId":
			err = unpopulate(val, &a.VsoAccountID)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
func (p *ProjectProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "accountId":
			err = unpopulate(val, &p.AccountID)
			delete(rawMsg, key)
		case "creationDate":
			err = unpopulateTimeRFC3339(val, &p.CreationDate)
			delete(rawMsg, key)
		case "description":
		...
		case "friendlyName":
			...
			delete(rawMsg, key)
		case "gitrepo":
			err = unpopulate(val, &p.Gitrepo)
			delete(rawMsg, key)
		case "projectId":
			err = unpopulate(val, &p.ProjectID)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, &p.ProvisioningState)
			delete(rawMsg, key)
		case "workspaceId":
			err = unpopulate(val, &p.WorkspaceID)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
func (w *WorkspaceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "accountId":
			err = unpopulate(val, &w.AccountID)
			delete(rawMsg, key)
		case "creationDate":
			err = unpopulateTimeRFC3339(val, &w.CreationDate)
			delete(rawMsg, key)
		case "description":
