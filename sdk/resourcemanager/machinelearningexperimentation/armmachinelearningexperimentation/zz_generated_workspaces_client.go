...
// method.
func (client *WorkspacesClient) ListByAccounts(accountName string, resourceGroupName string, options *WorkspacesClientListByAccountsOptions) *runtime.Pager[WorkspacesClientListByAccountsResponse] {
	return runtime.NewPager(runtime.PageProcessor[WorkspacesClientListByAccountsResponse]{
