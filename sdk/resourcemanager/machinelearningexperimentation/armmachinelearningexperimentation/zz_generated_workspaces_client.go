...
// method.
func (client *WorkspacesClient) ListByAccounts(accountName string, resourceGroupName string, options *WorkspacesClientListByAccountsOptions) *WorkspacesClientListByAccountsPager {
	return &WorkspacesClientListByAccountsPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listByAccountsCreateRequest(ctx, accountName, resourceGroupName, options)
		},
		advancer: func(ctx context.Context, resp WorkspacesClientListByAccountsResponse) (*policy.Request, error) {
