...
// Client contains the methods for the SoftwarePlan group.
...
func (client *Client) Register(ctx context.Context, options *ClientRegisterOptions) (ClientRegisterResponse, error) {
	...
	return ClientRegisterResponse{}, nil
}

// registerCreateRequest creates the Register request.
func (client *Client) registerCreateRequest(ctx context.Context, options *ClientRegisterOptions) (*policy.Request, error) {
