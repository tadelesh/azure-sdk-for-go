...
func NewNetworkExperimentProfilesClient(con *arm.Connection, subscriptionID string) *NetworkExperimentProfilesClient {
	return &NetworkExperimentProfilesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *NetworkExperimentProfilesClient) listHandleResponse(resp *http.Response) (NetworkExperimentProfilesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ProfileList); err != nil {
		return NetworkExperimentProfilesListResponse{}, err
	}
	return result, nil
}
...
func (client *NetworkExperimentProfilesClient) listByResourceGroupHandleResponse(resp *http.Response) (NetworkExperimentProfilesListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ProfileList); err != nil {
		return NetworkExperimentProfilesListByResourceGroupResponse{}, err
	}
	return result, nil
}
