...
func NewExperimentsClient(con *arm.Connection, subscriptionID string) *ExperimentsClient {
	return &ExperimentsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ExperimentsClient) listByProfileHandleResponse(resp *http.Response) (ExperimentsListByProfileResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ExperimentList); err != nil {
		return ExperimentsListByProfileResponse{}, err
	}
	return result, nil
}
