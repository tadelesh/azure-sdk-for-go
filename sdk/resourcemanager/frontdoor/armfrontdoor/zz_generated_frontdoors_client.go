...
func (client *FrontDoorsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, frontDoorName string, frontDoorParameters FrontDoor, options *FrontDoorsClientBeginCreateOrUpdateOptions) (*armruntime.Poller[FrontDoorsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[FrontDoorsClientCreateOrUpdateResponse]("FrontDoorsClient.CreateOrUpdate", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[FrontDoorsClientCreateOrUpdateResponse]("FrontDoorsClient.CreateOrUpdate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *FrontDoorsClient) BeginDelete(ctx context.Context, resourceGroupName string, frontDoorName string, options *FrontDoorsClientBeginDeleteOptions) (*armruntime.Poller[FrontDoorsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[FrontDoorsClientDeleteResponse]("FrontDoorsClient.Delete", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[FrontDoorsClientDeleteResponse]("FrontDoorsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
