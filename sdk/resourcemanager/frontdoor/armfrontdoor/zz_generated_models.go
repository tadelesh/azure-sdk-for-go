...
func (l LatencyScorecardProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "endDateTimeUTC", (*timeRFC3339)(l.EndDateTimeUTC))
	...
	populate(objectMap, "startDateTimeUTC", (*timeRFC3339)(l.StartDateTimeUTC))
	return json.Marshal(objectMap)
}
...
func (l *LatencyScorecardProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "endDateTimeUTC":
			...
			l.EndDateTimeUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "endpointA":
		...
		case "startDateTimeUTC":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			l.StartDateTimeUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
