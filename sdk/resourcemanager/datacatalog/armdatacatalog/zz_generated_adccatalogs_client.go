...
func NewADCCatalogsClient(con *arm.Connection, subscriptionID string, catalogName string) *ADCCatalogsClient {
	return &ADCCatalogsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, catalogName: catalogName}
}
