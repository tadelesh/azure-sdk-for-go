...
func NewAliasClient(con *arm.Connection) *AliasClient {
	return &AliasClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *AliasClient) getHandleResponse(resp *http.Response) (AliasGetResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PutAliasResponse); err != nil {
		return AliasGetResponse{}, err
	}
	return result, nil
}
...
func (client *AliasClient) listHandleResponse(resp *http.Response) (AliasListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PutAliasListResult); err != nil {
		return AliasListResponse{}, err
	}
	return result, nil
}
