...
// OperationResultsClientGetPoller provides polling facilities until the operation reaches a terminal state.
type OperationResultsClientGetPoller struct {
	pt *azcore.Poller
}

// Done returns true if the LRO has reached a terminal state.
func (p *OperationResultsClientGetPoller) Done() bool {
	return p.pt.Done()
}
...
func (p *OperationResultsClientGetPoller) Poll(ctx context.Context) (*http.Response, error) {
...
func (p *OperationResultsClientGetPoller) ResumeToken() (string, error) {
