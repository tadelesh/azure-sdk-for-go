...
func NewAscOperationsClient(con *arm.Connection, subscriptionID string) *AscOperationsClient {
	return &AscOperationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
