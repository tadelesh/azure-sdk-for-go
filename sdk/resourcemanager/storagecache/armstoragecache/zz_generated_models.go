...
func (c CacheUpgradeStatus) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "firmwareUpdateDeadline", (*timeRFC3339)(c.FirmwareUpdateDeadline))
	populate(objectMap, "firmwareUpdateStatus", c.FirmwareUpdateStatus)
	populate(objectMap, "lastFirmwareUpdate", (*timeRFC3339)(c.LastFirmwareUpdate))
...
func (c *CacheUpgradeStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "firmwareUpdateDeadline":
			...
			c.FirmwareUpdateDeadline = (*time.Time)(&aux)
			delete(rawMsg, key)
		...
		case "lastFirmwareUpdate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.LastFirmwareUpdate = (*time.Time)(&aux)
			delete(rawMsg, key)
