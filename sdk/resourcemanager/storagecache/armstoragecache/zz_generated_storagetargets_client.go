...
func NewStorageTargetsClient(con *arm.Connection, subscriptionID string) *StorageTargetsClient {
	return &StorageTargetsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *StorageTargetsClient) listByCacheHandleResponse(resp *http.Response) (StorageTargetsListByCacheResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.StorageTargetsResult); err != nil {
		return StorageTargetsListByCacheResponse{}, err
	}
	return result, nil
}
