...
func NewStorageTargetClient(con *arm.Connection, subscriptionID string) *StorageTargetClient {
	return &StorageTargetClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
