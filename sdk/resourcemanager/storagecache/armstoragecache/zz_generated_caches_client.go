...
func NewCachesClient(con *arm.Connection, subscriptionID string) *CachesClient {
	return &CachesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *CachesClient) listByResourceGroupHandleResponse(resp *http.Response) (CachesListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.CachesListResult); err != nil {
		return CachesListByResourceGroupResponse{}, err
	}
	return result, nil
}
