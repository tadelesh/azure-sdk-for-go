...
func NewPrivateLinkResourcesClient(con *arm.Connection, subscriptionID string, resourceGroupName string, azureResourceName string) *PrivateLinkResourcesClient {
	return &PrivateLinkResourcesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, resourceGroupName: resourceGroupName, azureResourceName: azureResourceName}
}
