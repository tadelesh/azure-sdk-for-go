...
func NewPrivateLinkServicesClient(con *arm.Connection, subscriptionID string, resourceGroupName string) *PrivateLinkServicesClient {
	return &PrivateLinkServicesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, resourceGroupName: resourceGroupName}
}
