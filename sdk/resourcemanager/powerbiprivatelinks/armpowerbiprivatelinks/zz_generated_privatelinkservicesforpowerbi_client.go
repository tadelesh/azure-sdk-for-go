...
func NewPrivateLinkServicesForPowerBIClient(con *arm.Connection, subscriptionID string) *PrivateLinkServicesForPowerBIClient {
	return &PrivateLinkServicesForPowerBIClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
