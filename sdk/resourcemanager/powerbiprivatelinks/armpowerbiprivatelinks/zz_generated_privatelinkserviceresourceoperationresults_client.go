...
func NewPrivateLinkServiceResourceOperationResultsClient(con *arm.Connection, subscriptionID string, operationID string) *PrivateLinkServiceResourceOperationResultsClient {
	return &PrivateLinkServiceResourceOperationResultsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, operationID: operationID}
}
