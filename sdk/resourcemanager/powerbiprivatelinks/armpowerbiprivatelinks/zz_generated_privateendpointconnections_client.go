...
func NewPrivateEndpointConnectionsClient(con *arm.Connection, subscriptionID string, resourceGroupName string, azureResourceName string, privateEndpointName string) *PrivateEndpointConnectionsClient {
	return &PrivateEndpointConnectionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, resourceGroupName: resourceGroupName, azureResourceName: azureResourceName, privateEndpointName: privateEndpointName}
}
