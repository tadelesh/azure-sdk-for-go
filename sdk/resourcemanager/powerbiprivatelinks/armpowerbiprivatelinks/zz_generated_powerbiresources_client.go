...
func NewPowerBIResourcesClient(con *arm.Connection, subscriptionID string, resourceGroupName string, azureResourceName string) *PowerBIResourcesClient {
	return &PowerBIResourcesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, resourceGroupName: resourceGroupName, azureResourceName: azureResourceName}
}
