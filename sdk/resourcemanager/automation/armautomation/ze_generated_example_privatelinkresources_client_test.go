...
func ExamplePrivateLinkResourcesClient_Automation() {
	...
	client := armautomation.NewPrivateLinkResourcesClient("<subscription-id>", cred, nil)
	pager := client.Automation("<resource-group-name>",
