...
// method.
func (client *ConnectorMappingsClient) ListByConnector(resourceGroupName string, hubName string, connectorName string, options *ConnectorMappingsClientListByConnectorOptions) *runtime.Pager[ConnectorMappingsClientListByConnectorResponse] {
	return runtime.NewPager(runtime.PageProcessor[ConnectorMappingsClientListByConnectorResponse]{
