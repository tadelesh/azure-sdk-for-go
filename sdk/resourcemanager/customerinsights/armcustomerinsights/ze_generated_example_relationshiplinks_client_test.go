...
func ExampleRelationshipLinksClient_BeginCreateOrUpdate() {
	...
	client := armcustomerinsights.NewRelationshipLinksClient("<subscription-id>", cred, nil)
	poller, err := client.BeginCreateOrUpdate(ctx,
		...
		armcustomerinsights.RelationshipLinkResourceFormat{
			Properties: &armcustomerinsights.RelationshipLinkDefinition{
				...
				InteractionType: to.Ptr("<interaction-type>"),
				LinkName:        to.Ptr("<link-name>"),
				ProfilePropertyReferences: []*armcustomerinsights.ParticipantProfilePropertyReference{
					{
						InteractionPropertyName: to.Ptr("<interaction-property-name>"),
						ProfilePropertyName:     to.Ptr("<profile-property-name>"),
					}},
				...
				RelationshipName: to.Ptr("<relationship-name>"),
			},
		},
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/tree/main/specification/customer-insights/resource-manager/Microsoft.CustomerInsights/stable/2017-04-26/examples/RelationshipLinksDelete.json
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/tree/main/specification/customer-insights/resource-manager/Microsoft.CustomerInsights/stable/2017-04-26/examples/RelationshipLinksListByHub.json
func ExampleRelationshipLinksClient_ListByHub() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
		return
