...
func NewOrchestratorInstanceServiceClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *OrchestratorInstanceServiceClient {
	if options == nil {
