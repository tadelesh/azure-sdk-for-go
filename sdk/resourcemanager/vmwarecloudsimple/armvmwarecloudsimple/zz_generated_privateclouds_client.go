...
func NewPrivateCloudsClient(con *arm.Connection, subscriptionID string) *PrivateCloudsClient {
	return &PrivateCloudsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *PrivateCloudsClient) listHandleResponse(resp *http.Response) (PrivateCloudsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PrivateCloudList); err != nil {
		return PrivateCloudsListResponse{}, err
	}
	return result, nil
}
