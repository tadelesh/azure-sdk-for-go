...
func (client *UsagesClient) List(regionID string, options *UsagesListOptions) *UsagesListPager {
...
func (client *UsagesClient) listCreateRequest(ctx context.Context, regionID string, options *UsagesListOptions) (*policy.Request, error) {
