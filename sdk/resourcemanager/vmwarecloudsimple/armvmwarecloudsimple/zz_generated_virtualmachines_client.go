...
func NewVirtualMachinesClient(con *arm.Connection, subscriptionID string, referer string) *VirtualMachinesClient {
	return &VirtualMachinesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, referer: referer}
}
...
func (client *VirtualMachinesClient) listByResourceGroupHandleResponse(resp *http.Response) (VirtualMachinesListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.VirtualMachineListResponse); err != nil {
		return VirtualMachinesListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
func (client *VirtualMachinesClient) listBySubscriptionHandleResponse(resp *http.Response) (VirtualMachinesListBySubscriptionResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.VirtualMachineListResponse); err != nil {
		return VirtualMachinesListBySubscriptionResponse{}, err
	}
	return result, nil
}
