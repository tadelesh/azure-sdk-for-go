...
func NewDedicatedCloudNodesClient(con *arm.Connection, subscriptionID string, referer string) *DedicatedCloudNodesClient {
	return &DedicatedCloudNodesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, referer: referer}
}
...
func (client *DedicatedCloudNodesClient) listByResourceGroupHandleResponse(resp *http.Response) (DedicatedCloudNodesListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.DedicatedCloudNodeListResponse); err != nil {
		return DedicatedCloudNodesListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
func (client *DedicatedCloudNodesClient) listBySubscriptionHandleResponse(resp *http.Response) (DedicatedCloudNodesListBySubscriptionResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.DedicatedCloudNodeListResponse); err != nil {
		return DedicatedCloudNodesListBySubscriptionResponse{}, err
	}
	return result, nil
}
