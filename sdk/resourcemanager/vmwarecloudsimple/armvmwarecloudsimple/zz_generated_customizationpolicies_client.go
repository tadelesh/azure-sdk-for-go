...
func NewCustomizationPoliciesClient(con *arm.Connection, subscriptionID string) *CustomizationPoliciesClient {
	return &CustomizationPoliciesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *CustomizationPoliciesClient) listHandleResponse(resp *http.Response) (CustomizationPoliciesListResponseEnvelope, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.CustomizationPoliciesListResponse); err != nil {
		return CustomizationPoliciesListResponseEnvelope{}, err
	}
	return result, nil
}
