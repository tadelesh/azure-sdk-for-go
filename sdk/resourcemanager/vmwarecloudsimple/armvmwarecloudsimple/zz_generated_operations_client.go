...
func NewOperationsClient(con *arm.Connection, subscriptionID string, referer string) *OperationsClient {
	return &OperationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID, referer: referer}
}
