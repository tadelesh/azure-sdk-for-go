...
func NewResourcePoolsClient(con *arm.Connection, subscriptionID string) *ResourcePoolsClient {
	return &ResourcePoolsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *ResourcePoolsClient) listHandleResponse(resp *http.Response) (ResourcePoolsListResponseEnvelope, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ResourcePoolsListResponse); err != nil {
		return ResourcePoolsListResponseEnvelope{}, err
	}
	return result, nil
}
