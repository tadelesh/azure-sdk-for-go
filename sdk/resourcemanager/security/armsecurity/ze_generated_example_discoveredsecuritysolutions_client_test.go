...
func ExampleDiscoveredSecuritySolutionsClient_List() {
	...
	client := armsecurity.NewDiscoveredSecuritySolutionsClient("<subscription-id>",
...
func ExampleDiscoveredSecuritySolutionsClient_ListByHomeRegion() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
		return
...
func ExampleDiscoveredSecuritySolutionsClient_Get() {
	...
	res, err := client.Get(ctx,
		"<resource-group-name>",
		"<discovered-security-solution-name>",
		nil)
	if err != nil {
