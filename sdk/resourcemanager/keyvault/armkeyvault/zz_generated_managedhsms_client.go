...
func (client *ManagedHsmsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, name string, parameters ManagedHsm, options *ManagedHsmsClientBeginCreateOrUpdateOptions) (*armruntime.Poller[ManagedHsmsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[ManagedHsmsClientCreateOrUpdateResponse]("ManagedHsmsClient.CreateOrUpdate", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[ManagedHsmsClientCreateOrUpdateResponse]("ManagedHsmsClient.CreateOrUpdate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *ManagedHsmsClient) BeginDelete(ctx context.Context, resourceGroupName string, name string, options *ManagedHsmsClientBeginDeleteOptions) (*armruntime.Poller[ManagedHsmsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[ManagedHsmsClientDeleteResponse]("ManagedHsmsClient.Delete", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[ManagedHsmsClientDeleteResponse]("ManagedHsmsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *ManagedHsmsClient) BeginPurgeDeleted(ctx context.Context, name string, location string, options *ManagedHsmsClientBeginPurgeDeletedOptions) (*armruntime.Poller[ManagedHsmsClientPurgeDeletedResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[ManagedHsmsClientPurgeDeletedResponse]("ManagedHsmsClient.PurgeDeleted", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[ManagedHsmsClientPurgeDeletedResponse]("ManagedHsmsClient.PurgeDeleted", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *ManagedHsmsClient) BeginUpdate(ctx context.Context, resourceGroupName string, name string, parameters ManagedHsm, options *ManagedHsmsClientBeginUpdateOptions) (*armruntime.Poller[ManagedHsmsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[ManagedHsmsClientUpdateResponse]("ManagedHsmsClient.Update", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[ManagedHsmsClientUpdateResponse]("ManagedHsmsClient.Update", options.ResumeToken, client.pl, nil)
	}
}
