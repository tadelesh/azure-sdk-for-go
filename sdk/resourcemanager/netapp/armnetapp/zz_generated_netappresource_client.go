...
func NewNetAppResourceClient(con *arm.Connection, subscriptionID string) *NetAppResourceClient {
	return &NetAppResourceClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
