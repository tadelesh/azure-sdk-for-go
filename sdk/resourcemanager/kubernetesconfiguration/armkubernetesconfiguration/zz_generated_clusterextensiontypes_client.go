...
// method.
func (client *ClusterExtensionTypesClient) List(resourceGroupName string, clusterRp ExtensionsClusterRp, clusterResourceName ExtensionsClusterResourceName, clusterName string, options *ClusterExtensionTypesClientListOptions) *runtime.Pager[ClusterExtensionTypesClientListResponse] {
	return runtime.NewPager(runtime.PageProcessor[ClusterExtensionTypesClientListResponse]{
		More: func(page ClusterExtensionTypesClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *ClusterExtensionTypesClientListResponse) (ClusterExtensionTypesClientListResponse, error) {
...
func (client *ClusterExtensionTypesClient) listHandleResponse(resp *http.Response) (ClusterExtensionTypesClientListResponse, error) {
	result := ClusterExtensionTypesClientListResponse{}
