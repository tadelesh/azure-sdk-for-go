...
// method.
func (client *LocationExtensionTypesClient) List(location string, options *LocationExtensionTypesClientListOptions) *runtime.Pager[LocationExtensionTypesClientListResponse] {
	return runtime.NewPager(runtime.PageProcessor[LocationExtensionTypesClientListResponse]{
		More: func(page LocationExtensionTypesClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *LocationExtensionTypesClientListResponse) (LocationExtensionTypesClientListResponse, error) {
...
func (client *LocationExtensionTypesClient) listHandleResponse(resp *http.Response) (LocationExtensionTypesClientListResponse, error) {
	result := LocationExtensionTypesClientListResponse{}
