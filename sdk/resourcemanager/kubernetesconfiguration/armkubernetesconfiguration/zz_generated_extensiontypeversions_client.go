...
// method.
func (client *ExtensionTypeVersionsClient) List(location string, extensionTypeName string, options *ExtensionTypeVersionsClientListOptions) *runtime.Pager[ExtensionTypeVersionsClientListResponse] {
	return runtime.NewPager(runtime.PageProcessor[ExtensionTypeVersionsClientListResponse]{
		More: func(page ExtensionTypeVersionsClientListResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *ExtensionTypeVersionsClientListResponse) (ExtensionTypeVersionsClientListResponse, error) {
			var req *policy.Request
			var err error
			if page == nil {
				req, err = client.listCreateRequest(ctx, location, extensionTypeName, options)
			} else {
