...
func (client *ManagersClient) ListMetrics(resourceGroupName string, managerName string, options *ManagersClientListMetricsOptions) *runtime.Pager[ManagersClientListMetricsResponse] {
