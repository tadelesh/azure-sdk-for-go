...
func (client *EmergingIssuesClient) List(options *EmergingIssuesClientListOptions) *runtime.Pager[EmergingIssuesClientListResponse] {
	return runtime.NewPager(runtime.PageProcessor[EmergingIssuesClientListResponse]{
