...
// method.
func (client *ChildAvailabilityStatusesClient) List(resourceURI string, options *ChildAvailabilityStatusesClientListOptions) *runtime.Pager[ChildAvailabilityStatusesClientListResponse] {
	return runtime.NewPager(runtime.PageProcessor[ChildAvailabilityStatusesClientListResponse]{
