...
func NewIotConnectorFhirDestinationClient(con *arm.Connection, subscriptionID string) *IotConnectorFhirDestinationClient {
	return &IotConnectorFhirDestinationClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
