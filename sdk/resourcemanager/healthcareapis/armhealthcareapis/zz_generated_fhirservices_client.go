...
func NewFhirServicesClient(con *arm.Connection, subscriptionID string) *FhirServicesClient {
	return &FhirServicesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *FhirServicesClient) listByWorkspaceHandleResponse(resp *http.Response) (FhirServicesListByWorkspaceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.FhirServiceCollection); err != nil {
		return FhirServicesListByWorkspaceResponse{}, err
	}
	return result, nil
}
