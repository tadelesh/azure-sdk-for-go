...
func NewDicomServicesClient(con *arm.Connection, subscriptionID string) *DicomServicesClient {
	return &DicomServicesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *DicomServicesClient) listByWorkspaceHandleResponse(resp *http.Response) (DicomServicesListByWorkspaceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.DicomServiceCollection); err != nil {
		return DicomServicesListByWorkspaceResponse{}, err
	}
	return result, nil
}
