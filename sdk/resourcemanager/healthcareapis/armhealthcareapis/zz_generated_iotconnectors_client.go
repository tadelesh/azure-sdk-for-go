...
func NewIotConnectorsClient(con *arm.Connection, subscriptionID string) *IotConnectorsClient {
	return &IotConnectorsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *IotConnectorsClient) listByWorkspaceHandleResponse(resp *http.Response) (IotConnectorsListByWorkspaceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.IotConnectorCollection); err != nil {
		return IotConnectorsListByWorkspaceResponse{}, err
	}
	return result, nil
}
