...
func TestOperations_List(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/OperationsGet.json
	...
	client := armdatabox.NewOperationsClient(cred, &options)
	pager := client.List(nil)
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		if err != nil {
			t.Fatalf("Failed to advance page for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/OperationsGet.json: %v", err)
			break
		}
		// Response check
		pagerExampleRes := armdatabox.OperationList{
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.OperationList) {
			...
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/OperationsGet.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestJobs_List(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsList.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsList"},
	})
	defer func() {
	...
	client := armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	pager := client.List(&armdatabox.JobsClientListOptions{SkipToken: nil})
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		if err != nil {
			t.Fatalf("Failed to advance page for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsList.json: %v", err)
			break
		}
		// Response check
		pagerExampleRes := armdatabox.JobResourceList{
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.JobResourceList) {
			...
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsList.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestJobs_MarkDevicesShipped(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/MarkDevicesShipped.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"MarkDevicesShipped"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	_, err := client.MarkDevicesShipped(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/MarkDevicesShipped.json: %v", err)
	}
}

func TestJobs_ListByResourceGroup(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsListByResourceGroup.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsListByResourceGroup"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		if err != nil {
			t.Fatalf("Failed to advance page for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsListByResourceGroup.json: %v", err)
			break
		}
		// Response check
		pagerExampleRes := armdatabox.JobResourceList{
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.JobResourceList) {
			exampleResJson, _ := json.Marshal(pagerExampleRes)
			mockResJson, _ := json.Marshal(nextResult.JobResourceList)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsListByResourceGroup.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestJobs_Get(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGet.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsGet"},
	})
	defer func() {
	...
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGet.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
			Identity: &armdatabox.ResourceIdentity{
				Type: to.Ptr("None"),
			},
			Location: to.Ptr("westus"),
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			...
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGet.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetCmk.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsGetCmk"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	res, err = client.Get(ctx,
		"SdkRg7937",
		...
		&armdatabox.JobsClientGetOptions{Expand: to.Ptr("details")})
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetCmk.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetCmk.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetCopyStuck.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsGetCopyStuck"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	res, err = client.Get(ctx,
		"dmstestresource",
		...
		&armdatabox.JobsClientGetOptions{Expand: to.Ptr("details")})
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetCopyStuck.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetCopyStuck.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetExport.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsGetExport"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	res, err = client.Get(ctx,
		"SdkRg8091",
		...
		&armdatabox.JobsClientGetOptions{Expand: to.Ptr("details")})
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetExport.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetExport.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetWaitingForAction.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsGetWaitingForAction"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	res, err = client.Get(ctx,
		"dmstestresource",
		...
		&armdatabox.JobsClientGetOptions{Expand: to.Ptr("details")})
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetWaitingForAction.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
				...
				Details: &armdatabox.JobDetails{
					...
					JobStages: []*armdatabox.JobStages{
						...
						},
						{
							DisplayName: to.Ptr("Data copy in progress"),
							StageName:   to.Ptr(armdatabox.StageNameDataCopy),
							StageStatus: to.Ptr(armdatabox.StageStatusWaitingForCustomerActionForCleanUp),
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsGetWaitingForAction.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestJobs_Create(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreate.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsCreate"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreate.json: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreate.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreate.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateDevicePassword.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsCreateDevicePassword"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	poller, err = client.BeginCreate(ctx,
		"SdkRg7478",
		...
		&armdatabox.JobsClientBeginCreateOptions{ResumeToken: ""})
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateDevicePassword.json: %v", err)
	}
	res, err = poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateDevicePassword.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateDevicePassword.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateDoubleEncryption.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsCreateDoubleEncryption"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	poller, err = client.BeginCreate(ctx,
		"SdkRg608",
		...
		&armdatabox.JobsClientBeginCreateOptions{ResumeToken: ""})
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateDoubleEncryption.json: %v", err)
	}
	res, err = poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateDoubleEncryption.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateDoubleEncryption.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateExport.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsCreateExport"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	poller, err = client.BeginCreate(ctx,
		"SdkRg8091",
		...
		&armdatabox.JobsClientBeginCreateOptions{ResumeToken: ""})
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateExport.json: %v", err)
	}
	res, err = poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateExport.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateExport.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateWithUserAssignedIdentity.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsCreateWithUserAssignedIdentity"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	poller, err = client.BeginCreate(ctx,
		"SdkRg7552",
		...
		&armdatabox.JobsClientBeginCreateOptions{ResumeToken: ""})
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateWithUserAssignedIdentity.json: %v", err)
	}
	res, err = poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateWithUserAssignedIdentity.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCreateWithUserAssignedIdentity.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestJobs_Delete(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsDelete.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsDelete"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsDelete.json: %v", err)
	}
	_, err = poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsDelete.json: %v", err)
	}
}

func TestJobs_Update(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatch.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsPatch"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatch.json: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatch.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatch.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatchCmk.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsPatchCmk"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	poller, err = client.BeginUpdate(ctx,
		"SdkRg7937",
	...
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatchCmk.json: %v", err)
	}
	res, err = poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatchCmk.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatchCmk.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}

	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatchSystemAssignedToUserAssigned.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsPatchSystemAssignedToUserAssigned"},
	})
	client = armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	poller, err = client.BeginUpdate(ctx,
		"SdkRg9765",
	...
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatchSystemAssignedToUserAssigned.json: %v", err)
	}
	res, err = poller.PollUntilDone(ctx, 30*time.Second)
	if err != nil {
		t.Fatalf("Failed to get LRO result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatchSystemAssignedToUserAssigned.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.JobResource{
		...
		if !reflect.DeepEqual(exampleRes, res.JobResource) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.JobResource)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsPatchSystemAssignedToUserAssigned.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestJobs_BookShipmentPickUp(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/BookShipmentPickupPost.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"BookShipmentPickupPost"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	res, err := client.BookShipmentPickUp(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/BookShipmentPickupPost.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.ShipmentPickUpResponse{
		...
		if !reflect.DeepEqual(exampleRes, res.ShipmentPickUpResponse) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.ShipmentPickUpResponse)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/BookShipmentPickupPost.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestJobs_Cancel(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCancelPost.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsCancelPost"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	_, err := client.Cancel(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsCancelPost.json: %v", err)
	}
}

func TestJobs_ListCredentials(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsListCredentials.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"JobsListCredentials"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	client := armdatabox.NewJobsClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	pager := client.ListCredentials("bvttoolrg6",
		"TJ-636646322037905056",
		nil)
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		if err != nil {
			t.Fatalf("Failed to advance page for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsListCredentials.json: %v", err)
			break
		}
		// Response check
		pagerExampleRes := armdatabox.UnencryptedCredentialsList{
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.UnencryptedCredentialsList) {
			exampleResJson, _ := json.Marshal(pagerExampleRes)
			mockResJson, _ := json.Marshal(nextResult.UnencryptedCredentialsList)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobsListCredentials.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestDataBoxManagementClient_Mitigate(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobMitigate.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"Mitigate"},
	})
	defer func() {
	...
	client := armdatabox.NewManagementClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	_, err := client.Mitigate(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/JobMitigate.json: %v", err)
	}
}

func TestService_ValidateAddress(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateAddressPost.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"ValidateAddressPost"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	client := armdatabox.NewServiceClient("fa68082f-8ff7-4a25-95c7-ce9da541242f", cred, &options)
	res, err := client.ValidateAddress(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateAddressPost.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.AddressValidationOutput{
		...
		if !reflect.DeepEqual(exampleRes, res.AddressValidationOutput) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.AddressValidationOutput)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateAddressPost.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestService_ValidateInputsByResourceGroup(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateInputsByResourceGroup.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"ValidateInputsByResourceGroup"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	res, err := client.ValidateInputsByResourceGroup(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateInputsByResourceGroup.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.ValidationResponse{
		...
		if !reflect.DeepEqual(exampleRes, res.ValidationResponse) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.ValidationResponse)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateInputsByResourceGroup.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestService_ValidateInputs(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateInputs.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"ValidateInputs"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	res, err := client.ValidateInputs(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateInputs.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.ValidationResponse{
		...
		if !reflect.DeepEqual(exampleRes, res.ValidationResponse) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.ValidationResponse)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/ValidateInputs.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestService_RegionConfiguration(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/RegionConfiguration.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"RegionConfiguration"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	res, err := client.RegionConfiguration(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/RegionConfiguration.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.RegionConfigurationResponse{
		...
		if !reflect.DeepEqual(exampleRes, res.RegionConfigurationResponse) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.RegionConfigurationResponse)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/RegionConfiguration.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}

func TestService_RegionConfigurationByResourceGroup(t *testing.T) {
	// From example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/RegionConfigurationByResourceGroup.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"RegionConfigurationByResourceGroup"},
	})
	defer func() {
		if r := recover(); r != nil {
			t.Fatal("stacktrace from panic: \n" + string(debug.Stack()))
	...
	res, err := client.RegionConfigurationByResourceGroup(ctx,
		...
		nil)
	if err != nil {
		t.Fatalf("Failed to get result for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/RegionConfigurationByResourceGroup.json: %v", err)
	}
	// Response check
	{
		exampleRes := armdatabox.RegionConfigurationResponse{
		...
		if !reflect.DeepEqual(exampleRes, res.RegionConfigurationResponse) {
			exampleResJson, _ := json.Marshal(exampleRes)
			mockResJson, _ := json.Marshal(res.RegionConfigurationResponse)
			t.Fatalf("Mock response is not equal to example response for example specification/databox/resource-manager/Microsoft.DataBox/preview/2021-08-01-preview/examples/RegionConfigurationByResourceGroup.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
