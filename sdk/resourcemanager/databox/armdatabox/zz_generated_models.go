...
func (j JobDeliveryInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "scheduledDateTime", (*timeRFC3339)(j.ScheduledDateTime))
	return json.Marshal(objectMap)
}
...
func (j *JobDeliveryInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "scheduledDateTime":
			...
			j.ScheduledDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
func (j JobStages) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "stageTime", (*timeRFC3339)(j.StageTime))
	return json.Marshal(objectMap)
}
...
func (l LastMitigationActionOnJob) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "actionDateTimeInUtc", (*timeRFC3339)(l.ActionDateTimeInUTC))
...
func (l *LastMitigationActionOnJob) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "actionDateTimeInUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			l.ActionDateTimeInUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (s ShipmentPickUpResponse) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "readyByTime", (*timeRFC3339)(s.ReadyByTime))
	return json.Marshal(objectMap)
}
