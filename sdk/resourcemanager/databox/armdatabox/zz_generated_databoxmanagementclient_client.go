...
func NewDataBoxManagementClient(con *arm.Connection, subscriptionID string) *DataBoxManagementClient {
	return &DataBoxManagementClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
