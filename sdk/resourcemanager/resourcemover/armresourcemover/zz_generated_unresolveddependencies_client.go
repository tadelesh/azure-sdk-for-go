...
func NewUnresolvedDependenciesClient(con *arm.Connection, subscriptionID string) *UnresolvedDependenciesClient {
	return &UnresolvedDependenciesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *UnresolvedDependenciesClient) getHandleResponse(resp *http.Response) (UnresolvedDependenciesGetResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.UnresolvedDependencyCollection); err != nil {
		return UnresolvedDependenciesGetResponse{}, err
	}
	return result, nil
}
