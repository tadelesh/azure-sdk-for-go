...
func (client *MoveResourcesClient) BeginCreate(ctx context.Context, resourceGroupName string, moveCollectionName string, moveResourceName string, options *MoveResourcesClientBeginCreateOptions) (*armruntime.Poller[MoveResourcesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[MoveResourcesClientCreateResponse]("MoveResourcesClient.Create", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[MoveResourcesClientCreateResponse]("MoveResourcesClient.Create", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *MoveResourcesClient) BeginDelete(ctx context.Context, resourceGroupName string, moveCollectionName string, moveResourceName string, options *MoveResourcesClientBeginDeleteOptions) (*armruntime.Poller[MoveResourcesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[MoveResourcesClientDeleteResponse]("MoveResourcesClient.Delete", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[MoveResourcesClientDeleteResponse]("MoveResourcesClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
