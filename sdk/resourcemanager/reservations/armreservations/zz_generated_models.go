...
func (p PaymentDetail) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "dueDate", (*dateType)(p.DueDate))
	populate(objectMap, "extendedStatusInfo", p.ExtendedStatusInfo)
	populate(objectMap, "paymentDate", (*dateType)(p.PaymentDate))
...
func (q QuotaRequestOneResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "requestSubmitTime", (*timeRFC3339)(q.RequestSubmitTime))
	return json.Marshal(objectMap)
}
...
func (q *QuotaRequestOneResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "requestSubmitTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			q.RequestSubmitTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
func (r ReservationOrderBillingPlanInformation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextPaymentDueDate", (*dateType)(r.NextPaymentDueDate))
	populate(objectMap, "pricingCurrencyTotal", r.PricingCurrencyTotal)
	populate(objectMap, "startDate", (*dateType)(r.StartDate))
...
func (r *ReservationOrderBillingPlanInformation) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "nextPaymentDueDate":
			var aux dateType
			err = unpopulate(val, &aux)
			r.NextPaymentDueDate = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "pricingCurrencyTotal":
...
func (r ReservationOrderProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "createdDateTime", (*timeRFC3339)(r.CreatedDateTime))
	populate(objectMap, "displayName", r.DisplayName)
	populate(objectMap, "expiryDate", (*dateType)(r.ExpiryDate))
	populate(objectMap, "originalQuantity", r.OriginalQuantity)
	populate(objectMap, "planInformation", r.PlanInformation)
	populate(objectMap, "provisioningState", r.ProvisioningState)
	populate(objectMap, "requestDateTime", (*timeRFC3339)(r.RequestDateTime))
...
func (r *ReservationOrderProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdDateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			r.CreatedDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "displayName":
		...
		case "requestDateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			r.RequestDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "reservations":
...
func (r *ReservationsProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "effectiveDateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			r.EffectiveDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "expiryDate":
			var aux dateType
			err = unpopulate(val, &aux)
		...
		case "lastUpdatedDateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			r.LastUpdatedDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
