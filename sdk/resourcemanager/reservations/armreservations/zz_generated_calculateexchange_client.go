...
func NewCalculateExchangeClient(con *arm.Connection) *CalculateExchangeClient {
	return &CalculateExchangeClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
