...
func NewQuotaRequestStatusClient(con *arm.Connection) *QuotaRequestStatusClient {
	return &QuotaRequestStatusClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *QuotaRequestStatusClient) listHandleResponse(resp *http.Response) (QuotaRequestStatusListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.QuotaRequestDetailsList); err != nil {
		return QuotaRequestStatusListResponse{}, err
	}
	return result, nil
}
