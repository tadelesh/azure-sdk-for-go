...
func NewReservationOrderClient(con *arm.Connection) *ReservationOrderClient {
	return &ReservationOrderClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *ReservationOrderClient) listHandleResponse(resp *http.Response) (ReservationOrderListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ReservationOrderList); err != nil {
		return ReservationOrderListResponse{}, err
	}
	return result, nil
}
