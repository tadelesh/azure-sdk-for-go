...
// Use a type switch to determine the concrete type.  The possible types are:
// - *DatabaseMigrationProperties, *DatabaseMigrationPropertiesSQLMi, *DatabaseMigrationPropertiesSQLVM
...
type NodeMonitoringData struct {
	...
	AdditionalProperties map[string]interface{} `json:"additionalProperties,omitempty" azure:"ro"`
...
type ProjectProperties struct {
	...
	AzureAuthenticationInfo *string `json:"azureAuthenticationInfo,omitempty"`
