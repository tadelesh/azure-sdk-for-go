...
func (client *FilesClient) List(groupName string, serviceName string, projectName string, options *FilesClientListOptions) *FilesClientListPager {
	return &FilesClientListPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listCreateRequest(ctx, groupName, serviceName, projectName, options)
		},
		advancer: func(ctx context.Context, resp FilesClientListResponse) (*policy.Request, error) {
