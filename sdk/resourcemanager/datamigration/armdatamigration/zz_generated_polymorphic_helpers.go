...
func unmarshalConnectionInfoClassificationArray(rawMsg json.RawMessage) ([]ConnectionInfoClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]ConnectionInfoClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalConnectionInfoClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
...
func unmarshalProjectTaskPropertiesClassificationArray(rawMsg json.RawMessage) ([]ProjectTaskPropertiesClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]ProjectTaskPropertiesClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalProjectTaskPropertiesClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
