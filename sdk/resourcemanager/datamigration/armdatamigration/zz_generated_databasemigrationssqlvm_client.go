...
func NewDatabaseMigrationsSQLVMClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *DatabaseMigrationsSQLVMClient {
	if options == nil {
...
// BeginCancel - Stop ongoing migration for the database.
...
// BeginCutover - Cutover online migration operation for the database.
// If the operation fails it returns an *azcore.ResponseError type.
// resourceGroupName - Name of the resource group that contains the resource. You can obtain this value from the Azure Resource
// Manager API or the portal.
// targetDbName - The name of the target database.
