...
func (client *ServiceTasksClient) List(groupName string, serviceName string, options *ServiceTasksClientListOptions) *ServiceTasksClientListPager {
	return &ServiceTasksClientListPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listCreateRequest(ctx, groupName, serviceName, options)
		},
		advancer: func(ctx context.Context, resp ServiceTasksClientListResponse) (*policy.Request, error) {
