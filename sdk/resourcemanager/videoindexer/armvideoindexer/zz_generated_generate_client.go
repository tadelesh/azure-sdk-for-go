...
func NewGenerateClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *GenerateClient {
	if options == nil {
...
// AccessToken - Generate an Azure Video Analyzer for Media access token.
