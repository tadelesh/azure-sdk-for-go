...
func NewSignalRPrivateEndpointConnectionsClient(con *arm.Connection, subscriptionID string) *SignalRPrivateEndpointConnectionsClient {
	return &SignalRPrivateEndpointConnectionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SignalRPrivateEndpointConnectionsClient) listHandleResponse(resp *http.Response) (SignalRPrivateEndpointConnectionsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PrivateEndpointConnectionList); err != nil {
		return SignalRPrivateEndpointConnectionsListResponse{}, err
	}
	return result, nil
}
