...
func (client *DedicatedHsmClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, name string, parameters DedicatedHsm, options *DedicatedHsmClientBeginCreateOrUpdateOptions) (*armruntime.Poller[DedicatedHsmClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[DedicatedHsmClientCreateOrUpdateResponse]("DedicatedHsmClient.CreateOrUpdate", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[DedicatedHsmClientCreateOrUpdateResponse]("DedicatedHsmClient.CreateOrUpdate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *DedicatedHsmClient) BeginDelete(ctx context.Context, resourceGroupName string, name string, options *DedicatedHsmClientBeginDeleteOptions) (*armruntime.Poller[DedicatedHsmClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[DedicatedHsmClientDeleteResponse]("DedicatedHsmClient.Delete", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[DedicatedHsmClientDeleteResponse]("DedicatedHsmClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *DedicatedHsmClient) BeginUpdate(ctx context.Context, resourceGroupName string, name string, parameters DedicatedHsmPatchParameters, options *DedicatedHsmClientBeginUpdateOptions) (*armruntime.Poller[DedicatedHsmClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[DedicatedHsmClientUpdateResponse]("DedicatedHsmClient.Update", "", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[DedicatedHsmClientUpdateResponse]("DedicatedHsmClient.Update", options.ResumeToken, client.pl, nil)
	}
}
