...
func (p *EnvironmentsCreateOrUpdatePoller) FinalResponse(ctx context.Context) (EnvironmentsCreateOrUpdateResponse, error) {
	...
	resp, err := p.pt.FinalResponse(ctx, &respType.EnvironmentResourceClassification)
	if err != nil {
...
// EnvironmentsUpdatePoller provides polling facilities until the operation reaches a terminal state.
type EnvironmentsUpdatePoller struct {
	pt *azcore.Poller
}

// Done returns true if the LRO has reached a terminal state.
func (p *EnvironmentsUpdatePoller) Done() bool {
	return p.pt.Done()
}
...
// Calling Poll on an LRO that has reached a terminal state will return the final
// HTTP response or error.
func (p *EnvironmentsUpdatePoller) Poll(ctx context.Context) (*http.Response, error) {
	return p.pt.Poll(ctx)
}

// FinalResponse performs a final GET to the service and returns the final response
// for the polling operation. If there is an error performing the final GET then an error is returned.
// If the final GET succeeded then the final EnvironmentsUpdateResponse will be returned.
func (p *EnvironmentsUpdatePoller) FinalResponse(ctx context.Context) (EnvironmentsUpdateResponse, error) {
...
// ResumeToken returns a value representing the poller that can be used to resume
// the LRO at a later time. ResumeTokens are unique per service operation.
func (p *EnvironmentsUpdatePoller) ResumeToken() (string, error) {
	return p.pt.ResumeToken()
}
