...
// ForecastsListResponse contains the response from method Forecasts.List.
type ForecastsListResponse struct {
	ForecastsListResultEnvelope
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// ForecastsListResultEnvelope contains the result from method Forecasts.List.
type ForecastsListResultEnvelope struct {
	ForecastsListResult
}
