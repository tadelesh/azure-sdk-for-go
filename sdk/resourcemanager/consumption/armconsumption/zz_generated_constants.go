...
// PossibleBoundValues returns the possible values for the Bound const type.
...
// PossibleChargeTypeValues returns the possible values for the ChargeType const type.
