...
func NewPriceSheetClient(con *arm.Connection, subscriptionID string) *PriceSheetClient {
	return &PriceSheetClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
