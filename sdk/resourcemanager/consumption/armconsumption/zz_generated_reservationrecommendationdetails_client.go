...
func (client *ReservationRecommendationDetailsClient) Get(ctx context.Context, scope string, scope1 Scope, region string, term Term, lookBackPeriod LookBackPeriod, product string, options *ReservationRecommendationDetailsGetOptions) (ReservationRecommendationDetailsGetResponse, error) {
	req, err := client.getCreateRequest(ctx, scope, scope1, region, term, lookBackPeriod, product, options)
	if err != nil {
...
func (client *ReservationRecommendationDetailsClient) getCreateRequest(ctx context.Context, scope string, scope1 Scope, region string, term Term, lookBackPeriod LookBackPeriod, product string, options *ReservationRecommendationDetailsGetOptions) (*policy.Request, error) {
