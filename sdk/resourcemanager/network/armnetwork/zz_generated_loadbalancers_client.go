...
func (client *LoadBalancersClient) BeginListInboundNatRulePortMappings(ctx context.Context, groupName string, loadBalancerName string, backendPoolName string, parameters QueryInboundNatRulePortMappingRequest, options *LoadBalancersClientBeginListInboundNatRulePortMappingsOptions) (*armruntime.Poller[LoadBalancersClientListInboundNatRulePortMappingsResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LoadBalancersClientListInboundNatRulePortMappingsResponse]("LoadBalancersClient.ListInboundNatRulePortMappings", "location", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LoadBalancersClientListInboundNatRulePortMappingsResponse]("LoadBalancersClient.ListInboundNatRulePortMappings", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *LoadBalancersClient) BeginSwapPublicIPAddresses(ctx context.Context, location string, parameters LoadBalancerVipSwapRequest, options *LoadBalancersClientBeginSwapPublicIPAddressesOptions) (*armruntime.Poller[LoadBalancersClientSwapPublicIPAddressesResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[LoadBalancersClientSwapPublicIPAddressesResponse]("LoadBalancersClient.SwapPublicIPAddresses", "location", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[LoadBalancersClientSwapPublicIPAddressesResponse]("LoadBalancersClient.SwapPublicIPAddresses", options.ResumeToken, client.pl, nil)
	}
}
