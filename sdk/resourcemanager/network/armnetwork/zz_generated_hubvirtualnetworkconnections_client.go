...
func (client *HubVirtualNetworkConnectionsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, virtualHubName string, connectionName string, hubVirtualNetworkConnectionParameters HubVirtualNetworkConnection, options *HubVirtualNetworkConnectionsClientBeginCreateOrUpdateOptions) (*armruntime.Poller[HubVirtualNetworkConnectionsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[HubVirtualNetworkConnectionsClientCreateOrUpdateResponse]("HubVirtualNetworkConnectionsClient.CreateOrUpdate", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[HubVirtualNetworkConnectionsClientCreateOrUpdateResponse]("HubVirtualNetworkConnectionsClient.CreateOrUpdate", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *HubVirtualNetworkConnectionsClient) BeginDelete(ctx context.Context, resourceGroupName string, virtualHubName string, connectionName string, options *HubVirtualNetworkConnectionsClientBeginDeleteOptions) (*armruntime.Poller[HubVirtualNetworkConnectionsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[HubVirtualNetworkConnectionsClientDeleteResponse]("HubVirtualNetworkConnectionsClient.Delete", "location", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[HubVirtualNetworkConnectionsClientDeleteResponse]("HubVirtualNetworkConnectionsClient.Delete", options.ResumeToken, client.pl, nil)
	}
}
