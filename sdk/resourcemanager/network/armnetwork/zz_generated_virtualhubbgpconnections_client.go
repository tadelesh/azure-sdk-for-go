...
func (client *VirtualHubBgpConnectionsClient) BeginListAdvertisedRoutes(ctx context.Context, resourceGroupName string, hubName string, connectionName string, options *VirtualHubBgpConnectionsClientBeginListAdvertisedRoutesOptions) (*armruntime.Poller[VirtualHubBgpConnectionsClientListAdvertisedRoutesResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[VirtualHubBgpConnectionsClientListAdvertisedRoutesResponse]("VirtualHubBgpConnectionsClient.ListAdvertisedRoutes", "location", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[VirtualHubBgpConnectionsClientListAdvertisedRoutesResponse]("VirtualHubBgpConnectionsClient.ListAdvertisedRoutes", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *VirtualHubBgpConnectionsClient) BeginListLearnedRoutes(ctx context.Context, resourceGroupName string, hubName string, connectionName string, options *VirtualHubBgpConnectionsClientBeginListLearnedRoutesOptions) (*armruntime.Poller[VirtualHubBgpConnectionsClientListLearnedRoutesResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[VirtualHubBgpConnectionsClientListLearnedRoutesResponse]("VirtualHubBgpConnectionsClient.ListLearnedRoutes", "location", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[VirtualHubBgpConnectionsClientListLearnedRoutesResponse]("VirtualHubBgpConnectionsClient.ListLearnedRoutes", options.ResumeToken, client.pl, nil)
	}
}
