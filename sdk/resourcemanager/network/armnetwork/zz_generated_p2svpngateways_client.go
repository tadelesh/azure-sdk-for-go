...
func (client *P2SVPNGatewaysClient) BeginReset(ctx context.Context, resourceGroupName string, gatewayName string, options *P2SVPNGatewaysClientBeginResetOptions) (*armruntime.Poller[P2SVPNGatewaysClientResetResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[P2SVPNGatewaysClientResetResponse]("P2SVPNGatewaysClient.Reset", "location", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[P2SVPNGatewaysClientResetResponse]("P2SVPNGatewaysClient.Reset", options.ResumeToken, client.pl, nil)
	}
}
...
func (client *P2SVPNGatewaysClient) BeginUpdateTags(ctx context.Context, resourceGroupName string, gatewayName string, p2SVPNGatewayParameters TagsObject, options *P2SVPNGatewaysClientBeginUpdateTagsOptions) (*armruntime.Poller[P2SVPNGatewaysClientUpdateTagsResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return armruntime.NewPoller[P2SVPNGatewaysClientUpdateTagsResponse]("P2SVPNGatewaysClient.UpdateTags", "azure-async-operation", resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[P2SVPNGatewaysClientUpdateTagsResponse]("P2SVPNGatewaysClient.UpdateTags", options.ResumeToken, client.pl, nil)
	}
}
