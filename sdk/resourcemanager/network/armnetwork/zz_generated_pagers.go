...
func (p *ApplicationGatewayPrivateEndpointConnectionsClientListPager) More() bool {
...
func (p *ApplicationGatewayPrivateEndpointConnectionsClientListPager) NextPage(ctx context.Context) (ApplicationGatewayPrivateEndpointConnectionsClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return ApplicationGatewayPrivateEndpointConnectionsClientListResponse{}, errors.New("no more pages")
		}
...
// More returns true if there are more pages to retrieve.
func (p *ApplicationGatewayPrivateLinkResourcesClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *ApplicationGatewayPrivateLinkResourcesClientListPager) NextPage(ctx context.Context) (ApplicationGatewayPrivateLinkResourcesClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return ApplicationGatewayPrivateLinkResourcesClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *CustomIPPrefixesClientListAllPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *CustomIPPrefixesClientListAllPager) NextPage(ctx context.Context) (CustomIPPrefixesClientListAllResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return CustomIPPrefixesClientListAllResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *CustomIPPrefixesClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.CustomIPPrefixListResult.NextLink == nil || len(*p.current.CustomIPPrefixListResult.NextLink) == 0 {
			return false
		}
...
// NextPage advances the pager to the next page.
func (p *CustomIPPrefixesClientListPager) NextPage(ctx context.Context) (CustomIPPrefixesClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return CustomIPPrefixesClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *DscpConfigurationClientListAllPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *DscpConfigurationClientListAllPager) NextPage(ctx context.Context) (DscpConfigurationClientListAllResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return DscpConfigurationClientListAllResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *DscpConfigurationClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.DscpConfigurationListResult.NextLink == nil || len(*p.current.DscpConfigurationListResult.NextLink) == 0 {
			return false
		}
...
// NextPage advances the pager to the next page.
func (p *DscpConfigurationClientListPager) NextPage(ctx context.Context) (DscpConfigurationClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return DscpConfigurationClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *FirewallPolicyRuleCollectionGroupsClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *FirewallPolicyRuleCollectionGroupsClientListPager) NextPage(ctx context.Context) (FirewallPolicyRuleCollectionGroupsClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return FirewallPolicyRuleCollectionGroupsClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *HubRouteTablesClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *HubRouteTablesClientListPager) NextPage(ctx context.Context) (HubRouteTablesClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return HubRouteTablesClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *InterfacesClientListCloudServiceNetworkInterfacesPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.InterfaceListResult.NextLink == nil || len(*p.current.InterfaceListResult.NextLink) == 0 {
			return false
		}
...
// NextPage advances the pager to the next page.
func (p *InterfacesClientListCloudServiceNetworkInterfacesPager) NextPage(ctx context.Context) (InterfacesClientListCloudServiceNetworkInterfacesResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return InterfacesClientListCloudServiceNetworkInterfacesResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *InterfacesClientListCloudServiceRoleInstanceNetworkInterfacesPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.InterfaceListResult.NextLink == nil || len(*p.current.InterfaceListResult.NextLink) == 0 {
			return false
		}
...
// NextPage advances the pager to the next page.
func (p *InterfacesClientListCloudServiceRoleInstanceNetworkInterfacesPager) NextPage(ctx context.Context) (InterfacesClientListCloudServiceRoleInstanceNetworkInterfacesResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return InterfacesClientListCloudServiceRoleInstanceNetworkInterfacesResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *NatRulesClientListByVPNGatewayPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *NatRulesClientListByVPNGatewayPager) NextPage(ctx context.Context) (NatRulesClientListByVPNGatewayResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return NatRulesClientListByVPNGatewayResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *PublicIPAddressesClientListCloudServicePublicIPAddressesPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.PublicIPAddressListResult.NextLink == nil || len(*p.current.PublicIPAddressListResult.NextLink) == 0 {
			return false
		}
...
// NextPage advances the pager to the next page.
func (p *PublicIPAddressesClientListCloudServicePublicIPAddressesPager) NextPage(ctx context.Context) (PublicIPAddressesClientListCloudServicePublicIPAddressesResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return PublicIPAddressesClientListCloudServicePublicIPAddressesResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *PublicIPAddressesClientListCloudServiceRoleInstancePublicIPAddressesPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.PublicIPAddressListResult.NextLink == nil || len(*p.current.PublicIPAddressListResult.NextLink) == 0 {
			return false
		}
...
// NextPage advances the pager to the next page.
func (p *PublicIPAddressesClientListCloudServiceRoleInstancePublicIPAddressesPager) NextPage(ctx context.Context) (PublicIPAddressesClientListCloudServiceRoleInstancePublicIPAddressesResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return PublicIPAddressesClientListCloudServiceRoleInstancePublicIPAddressesResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *RoutingIntentClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *RoutingIntentClientListPager) NextPage(ctx context.Context) (RoutingIntentClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return RoutingIntentClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *ServiceTagInformationClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *ServiceTagInformationClientListPager) NextPage(ctx context.Context) (ServiceTagInformationClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return ServiceTagInformationClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *VirtualApplianceSKUsClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *VirtualApplianceSKUsClientListPager) NextPage(ctx context.Context) (VirtualApplianceSKUsClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return VirtualApplianceSKUsClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *VirtualApplianceSitesClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *VirtualApplianceSitesClientListPager) NextPage(ctx context.Context) (VirtualApplianceSitesClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return VirtualApplianceSitesClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *VirtualHubBgpConnectionsClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *VirtualHubBgpConnectionsClientListPager) NextPage(ctx context.Context) (VirtualHubBgpConnectionsClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return VirtualHubBgpConnectionsClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *VirtualHubIPConfigurationClientListPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *VirtualHubIPConfigurationClientListPager) NextPage(ctx context.Context) (VirtualHubIPConfigurationClientListResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return VirtualHubIPConfigurationClientListResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *VirtualNetworkGatewayNatRulesClientListByVirtualNetworkGatewayPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *VirtualNetworkGatewayNatRulesClientListByVirtualNetworkGatewayPager) NextPage(ctx context.Context) (VirtualNetworkGatewayNatRulesClientListByVirtualNetworkGatewayResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return VirtualNetworkGatewayNatRulesClientListByVirtualNetworkGatewayResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
...
// More returns true if there are more pages to retrieve.
func (p *WebCategoriesClientListBySubscriptionPager) More() bool {
	if !reflect.ValueOf(p.current).IsZero() {
...
// NextPage advances the pager to the next page.
func (p *WebCategoriesClientListBySubscriptionPager) NextPage(ctx context.Context) (WebCategoriesClientListBySubscriptionResponse, error) {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if !p.More() {
			return WebCategoriesClientListBySubscriptionResponse{}, errors.New("no more pages")
		}
		req, err = p.advancer(ctx, p.current)
	} else {
		req, err = p.requester(ctx)
