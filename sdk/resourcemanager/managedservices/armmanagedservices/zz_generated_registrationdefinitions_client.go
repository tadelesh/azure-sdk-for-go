...
func NewRegistrationDefinitionsClient(con *arm.Connection) *RegistrationDefinitionsClient {
	return &RegistrationDefinitionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *RegistrationDefinitionsClient) listHandleResponse(resp *http.Response) (RegistrationDefinitionsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RegistrationDefinitionList); err != nil {
		return RegistrationDefinitionsListResponse{}, err
	}
	return result, nil
}
