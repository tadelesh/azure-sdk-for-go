...
func NewMarketplaceRegistrationDefinitionsClient(con *arm.Connection) *MarketplaceRegistrationDefinitionsClient {
	return &MarketplaceRegistrationDefinitionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *MarketplaceRegistrationDefinitionsClient) listHandleResponse(resp *http.Response) (MarketplaceRegistrationDefinitionsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.MarketplaceRegistrationDefinitionList); err != nil {
		return MarketplaceRegistrationDefinitionsListResponse{}, err
	}
	return result, nil
}
