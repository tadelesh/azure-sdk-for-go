...
func NewRegistrationAssignmentsClient(con *arm.Connection) *RegistrationAssignmentsClient {
	return &RegistrationAssignmentsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version)}
}
...
func (client *RegistrationAssignmentsClient) listHandleResponse(resp *http.Response) (RegistrationAssignmentsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RegistrationAssignmentList); err != nil {
		return RegistrationAssignmentsListResponse{}, err
	}
	return result, nil
}
