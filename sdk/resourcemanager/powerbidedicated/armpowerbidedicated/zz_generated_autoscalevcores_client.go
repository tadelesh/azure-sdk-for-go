...
func NewAutoScaleVCoresClient(con *arm.Connection, subscriptionID string) *AutoScaleVCoresClient {
	return &AutoScaleVCoresClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
