...
func NewCapacitiesClient(con *arm.Connection, subscriptionID string) *CapacitiesClient {
	return &CapacitiesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
