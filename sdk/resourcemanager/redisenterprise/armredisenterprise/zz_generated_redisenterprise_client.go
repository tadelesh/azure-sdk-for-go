...
func NewRedisEnterpriseClient(con *arm.Connection, subscriptionID string) *RedisEnterpriseClient {
	return &RedisEnterpriseClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *RedisEnterpriseClient) listHandleResponse(resp *http.Response) (RedisEnterpriseListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ClusterList); err != nil {
		return RedisEnterpriseListResponse{}, err
	}
	return result, nil
}
...
func (client *RedisEnterpriseClient) listByResourceGroupHandleResponse(resp *http.Response) (RedisEnterpriseListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ClusterList); err != nil {
		return RedisEnterpriseListByResourceGroupResponse{}, err
	}
	return result, nil
}
