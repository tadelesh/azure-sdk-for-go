...
func NewOperationsStatusClient(con *arm.Connection, subscriptionID string) *OperationsStatusClient {
	return &OperationsStatusClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
