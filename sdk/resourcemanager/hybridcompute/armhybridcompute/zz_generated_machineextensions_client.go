...
func NewMachineExtensionsClient(con *arm.Connection, subscriptionID string) *MachineExtensionsClient {
	return &MachineExtensionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *MachineExtensionsClient) listHandleResponse(resp *http.Response) (MachineExtensionsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.MachineExtensionsListResult); err != nil {
		return MachineExtensionsListResponse{}, err
	}
	return result, nil
}
