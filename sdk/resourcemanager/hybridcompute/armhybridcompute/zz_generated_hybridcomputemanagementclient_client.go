...
func NewHybridComputeManagementClient(con *arm.Connection, subscriptionID string) *HybridComputeManagementClient {
	return &HybridComputeManagementClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
