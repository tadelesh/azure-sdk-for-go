...
func NewMariaDBManagementClient(con *arm.Connection, subscriptionID string) *MariaDBManagementClient {
	return &MariaDBManagementClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
